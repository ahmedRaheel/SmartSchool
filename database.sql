...
CREATE TABLE communication.notification (
    ...
    tenant_id uuid NOT NULL REFERENCES saas.tenant(tenant_id),
    recipient_user_id uuid NOT NULL REFERENCES identity_ref.user_profile(user_id),
...
CREATE INDEX ix_notification_tenant_recipient ON communication.notification(tenant_id, recipient_user_id);
CREATE INDEX ix_notification_tenant_recipient_unread ON communication.notification(tenant_id, recipient_user_id, is_read);
CREATE INDEX ix_notification_tenant_recipient_occurred ON communication.notification(tenant_id, recipient_user_id, occurred_at DESC);
