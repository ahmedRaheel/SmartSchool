...
-- Restore definitions referenced by the original canonical schema.
CREATE TABLE academic.program_subject (
 program_subject_id uuid DEFAULT gen_random_uuid() NOT NULL,
 tenant_id uuid NOT NULL, program_grade_id uuid NOT NULL, subject_id uuid NOT NULL,
 requirement_type_code varchar(40) NOT NULL DEFAULT 'COMPULSORY', periods_per_week integer,
 minimum_pass_marks numeric(8,2), display_order integer NOT NULL DEFAULT 0,
 is_active boolean NOT NULL DEFAULT true, created_at timestamptz NOT NULL DEFAULT now(),
 updated_at timestamptz, row_version bytea NOT NULL DEFAULT public.gen_random_bytes(8)
);
CREATE TABLE academic.section (
 section_id uuid PRIMARY KEY DEFAULT gen_random_uuid(), tenant_id uuid NOT NULL,
 code varchar(100) NOT NULL, name varchar(250) NOT NULL,
 is_active boolean NOT NULL DEFAULT true, created_at timestamptz NOT NULL DEFAULT now(),
 updated_at timestamptz, row_version bytea NOT NULL DEFAULT public.gen_random_bytes(8)
);
...
INSERT INTO ai_core.tool_definition (tool_definition_id, code, name, description, handler_key, requires_user_authorization, requires_human_approval, is_active) VALUES
(E'ee8cbb19-1d36-42de-872b-6e3490f07270', E'GET_STUDENT_SUBJECTS', E'Get Student Subjects', NULL, E'Tutor.GetStudentSubjects', E't', E'f', E't'),
(E'57fd4968-1cde-4040-a86a-1772eadae55d', E'SEARCH_COURSE_MATERIAL', E'Search Course Material', NULL, E'Tutor.SearchCourseMaterial', E't', E'f', E't'),
(E'02095f67-5eeb-4d16-ab09-378e4773d7b2', E'GENERATE_PRACTICE_QUIZ', E'Generate Practice Quiz', NULL, E'Tutor.GeneratePracticeQuiz', E't', E'f', E't'),
(E'b4372afb-b63f-4c64-9ea9-4e4c13be176d', E'GET_STUDENT_PROGRESS', E'Get Student Progress', NULL, E'Tutor.GetStudentProgress', E't', E'f', E't'),
(E'9476acce-5d22-4d86-afab-b5900bc5b74a', E'GET_PROGRAMS', E'Get School Programs', NULL, E'Inquiry.GetPrograms', E'f', E'f', E't'),
(E'4ac125e6-e496-45aa-a95d-95b849f939f5', E'GET_ADMISSION_INFO', E'Get Admission Information', NULL, E'Inquiry.GetAdmissionInfo', E'f', E'f', E't'),
(E'0d872c40-504e-46af-9cff-0aa213ec60d3', E'CREATE_ADMISSION_INQUIRY', E'Create Admission Inquiry', NULL, E'Inquiry.CreateAdmissionInquiry', E'f', E't', E't'),
(E'f456430b-7cb4-4735-8f92-729eddc2f047', E'REQUEST_HUMAN_HANDOFF', E'Request Human Handoff', NULL, E'Inquiry.RequestHumanHandoff', E'f', E'f', E't'),
(E'e85f1e63-7abc-40d0-b0c3-c12ad1dfe598', E'GET_CHILD_ATTENDANCE', E'Get Child Attendance', NULL, E'Parent.GetChildAttendance', E't', E'f', E't'),
(E'72691771-74e7-4077-aa0f-d1f9c4d84539', E'GET_CHILD_RESULTS', E'Get Child Results', NULL, E'Parent.GetChildResults', E't', E'f', E't'),
(E'b04f1959-6ce6-4ded-b920-170d6b0f090b', E'GET_CHILD_TIMETABLE', E'Get Child Timetable', NULL, E'Parent.GetChildTimetable', E't', E'f', E't'),
(E'42bd163f-a7de-4bdd-bc38-3681ddb7afb9', E'GET_CHILD_FEE_BALANCE', E'Get Child Fee Balance', NULL, E'Parent.GetChildFeeBalance', E't', E'f', E't');
...
INSERT INTO communication."NotificationTypeLookup" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'31000000-0000-0000-0000-000000000001', E'EXAMSCHEDULED', E'ExamScheduled', E'1', E't'),
(E'31000000-0000-0000-0000-000000000002', E'EXAMSTARTINGSOON', E'ExamStartingSoon', E'2', E't'),
(E'31000000-0000-0000-0000-000000000003', E'EXAMRESULTPUBLISHED', E'ExamResultPublished', E'3', E't'),
(E'31000000-0000-0000-0000-000000000004', E'TIMETABLEPUBLISHED', E'TimetablePublished', E'4', E't'),
(E'31000000-0000-0000-0000-000000000005', E'TIMETABLECHANGED', E'TimetableChanged', E'5', E't'),
(E'31000000-0000-0000-0000-000000000006', E'CLASSTIMINGCHANGED', E'ClassTimingChanged', E'6', E't'),
(E'31000000-0000-0000-0000-000000000007', E'EIDHOLIDAY', E'EidHoliday', E'7', E't'),
(E'31000000-0000-0000-0000-000000000008', E'SUMMERVACATION', E'SummerVacation', E'8', E't'),
(E'31000000-0000-0000-0000-000000000009', E'WINTERVACATION', E'WinterVacation', E'9', E't'),
(E'31000000-0000-0000-0000-000000000010', E'PUBLICHOLIDAY', E'PublicHoliday', E'10', E't'),
(E'31000000-0000-0000-0000-000000000011', E'FEEDUE', E'FeeDue', E'11', E't'),
(E'31000000-0000-0000-0000-000000000012', E'FEEOVERDUE', E'FeeOverdue', E'12', E't'),
(E'31000000-0000-0000-0000-000000000013', E'FEESUBMITTED', E'FeeSubmitted', E'13', E't'),
(E'31000000-0000-0000-0000-000000000014', E'FEEPAYMENTCONFIRMED', E'FeePaymentConfirmed', E'14', E't'),
(E'31000000-0000-0000-0000-000000000015', E'FEEWAIVED', E'FeeWaived', E'15', E't'),
(E'31000000-0000-0000-0000-000000000016', E'LEAVESUBMITTED', E'LeaveSubmitted', E'16', E't'),
(E'31000000-0000-0000-0000-000000000017', E'LEAVEACCEPTED', E'LeaveAccepted', E'17', E't'),
(E'31000000-0000-0000-0000-000000000018', E'LEAVEREJECTED', E'LeaveRejected', E'18', E't'),
(E'31000000-0000-0000-0000-000000000019', E'LEAVECANCELLED', E'LeaveCancelled', E'19', E't'),
(E'31000000-0000-0000-0000-000000000020', E'ADMISSIONSUBMITTED', E'AdmissionSubmitted', E'20', E't'),
(E'31000000-0000-0000-0000-000000000021', E'ADMISSIONACCEPTED', E'AdmissionAccepted', E'21', E't'),
(E'31000000-0000-0000-0000-000000000022', E'ADMISSIONREJECTED', E'AdmissionRejected', E'22', E't'),
(E'31000000-0000-0000-0000-000000000023', E'ADMISSIONTERMINATED', E'AdmissionTerminated', E'23', E't'),
(E'31000000-0000-0000-0000-000000000024', E'EVENTCREATED', E'EventCreated', E'24', E't'),
(E'31000000-0000-0000-0000-000000000025', E'EVENTPOSTPONED', E'EventPostponed', E'25', E't'),
(E'31000000-0000-0000-0000-000000000026', E'EVENTCANCELLED', E'EventCancelled', E'26', E't'),
(E'31000000-0000-0000-0000-000000000027', E'EVENTREMINDER', E'EventReminder', E'27', E't'),
(E'31000000-0000-0000-0000-000000000028', E'ATTENDANCEABSENT', E'AttendanceAbsent', E'28', E't'),
(E'31000000-0000-0000-0000-000000000029', E'ATTENDANCELATE', E'AttendanceLate', E'29', E't'),
(E'31000000-0000-0000-0000-000000000030', E'ATTENDANCESUMMARY', E'AttendanceSummary', E'30', E't'),
(E'31000000-0000-0000-0000-000000000031', E'ASSIGNMENTCREATED', E'AssignmentCreated', E'31', E't'),
(E'31000000-0000-0000-0000-000000000032', E'ASSIGNMENTDUE', E'AssignmentDue', E'32', E't'),
(E'31000000-0000-0000-0000-000000000033', E'ASSIGNMENTGRADED', E'AssignmentGraded', E'33', E't'),
(E'31000000-0000-0000-0000-000000000034', E'ANNOUNCEMENTPUBLISHED', E'AnnouncementPublished', E'34', E't'),
(E'31000000-0000-0000-0000-000000000035', E'EMERGENCYALERT', E'EmergencyAlert', E'35', E't'),
(E'31000000-0000-0000-0000-000000000036', E'TRANSPORTDELAY', E'TransportDelay', E'36', E't'),
(E'31000000-0000-0000-0000-000000000037', E'TRANSPORTROUTECHANGED', E'TransportRouteChanged', E'37', E't'),
(E'31000000-0000-0000-0000-000000000038', E'PARENTTEACHERMEETING', E'ParentTeacherMeeting', E'38', E't'),
(E'31000000-0000-0000-0000-000000000039', E'TEACHERSUBSTITUTION', E'TeacherSubstitution', E'39', E't'),
(E'31000000-0000-0000-0000-000000000040', E'REPORTCARDPUBLISHED', E'ReportCardPublished', E'40', E't'),
(E'31000000-0000-0000-0000-000000000041', E'GENERAL', E'General', E'41', E't');
...
INSERT INTO hangfire.schema (version) VALUES
(E'23');
...
INSERT INTO reference."AttendanceStatusType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'19000000-0000-0000-0000-000000000001', E'PRESENT', E'Present', E'1', E't'),
(E'19000000-0000-0000-0000-000000000002', E'ABSENT', E'Absent', E'2', E't'),
(E'19000000-0000-0000-0000-000000000003', E'LATE', E'Late', E'3', E't'),
(E'19000000-0000-0000-0000-000000000004', E'EXCUSED', E'Excused', E'4', E't'),
(E'19000000-0000-0000-0000-000000000005', E'LEAVE', E'Leave', E'5', E't');
...
INSERT INTO reference."BloodGroupType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'13000000-0000-0000-0000-000000000001', E'A+', E'A+', E'1', E't'),
(E'13000000-0000-0000-0000-000000000002', E'A-', E'A-', E'2', E't'),
(E'13000000-0000-0000-0000-000000000003', E'B+', E'B+', E'3', E't'),
(E'13000000-0000-0000-0000-000000000004', E'B-', E'B-', E'4', E't'),
(E'13000000-0000-0000-0000-000000000005', E'AB+', E'AB+', E'5', E't'),
(E'13000000-0000-0000-0000-000000000006', E'AB-', E'AB-', E'6', E't'),
(E'13000000-0000-0000-0000-000000000007', E'O+', E'O+', E'7', E't'),
(E'13000000-0000-0000-0000-000000000008', E'O-', E'O-', E'8', E't');
...
INSERT INTO reference."DocumentTypeLookup" ("Id", "Code", "Name", "OwnerCategory", "IsIdentityDocument", "RequiresExpiryDate", "RequiresVerification", "DisplayOrder", "IsActive") VALUES
(E'21000000-0000-0000-0000-000000000001', E'PROFILE_PICTURE', E'Profile Picture', E'ANY', E'f', E'f', E'f', E'1', E't'),
(E'21000000-0000-0000-0000-000000000002', E'BIRTH_CERTIFICATE', E'Birth Certificate', E'STUDENT', E't', E'f', E't', E'2', E't'),
(E'21000000-0000-0000-0000-000000000003', E'B_FORM', E'B-Form', E'STUDENT', E't', E'f', E't', E'3', E't'),
(E'21000000-0000-0000-0000-000000000004', E'CNIC_FRONT', E'CNIC Front', E'ADULT', E't', E't', E't', E'4', E't'),
(E'21000000-0000-0000-0000-000000000005', E'CNIC_BACK', E'CNIC Back', E'ADULT', E't', E't', E't', E'5', E't'),
(E'21000000-0000-0000-0000-000000000006', E'PASSPORT', E'Passport', E'ANY', E't', E't', E't', E'6', E't'),
(E'21000000-0000-0000-0000-000000000007', E'ACADEMIC_CERTIFICATE', E'Academic Certificate', E'ANY', E'f', E'f', E't', E'7', E't'),
(E'21000000-0000-0000-0000-000000000008', E'DEGREE', E'Degree', E'EMPLOYEE', E'f', E'f', E't', E'8', E't'),
(E'21000000-0000-0000-0000-000000000009', E'EXPERIENCE_CERTIFICATE', E'Experience Certificate', E'EMPLOYEE', E'f', E'f', E't', E'9', E't'),
(E'21000000-0000-0000-0000-000000000010', E'DRIVING_LICENSE', E'Driving License', E'DRIVER', E't', E't', E't', E'10', E't'),
(E'21000000-0000-0000-0000-000000000011', E'POLICE_VERIFICATION', E'Police Verification', E'EMPLOYEE', E't', E't', E't', E'11', E't'),
(E'21000000-0000-0000-0000-000000000012', E'MEDICAL_CERTIFICATE', E'Medical Certificate', E'ANY', E't', E't', E't', E'12', E't'),
(E'21000000-0000-0000-0000-000000000013', E'RESUME', E'Resume', E'EMPLOYEE', E'f', E'f', E'f', E'13', E't'),
(E'21000000-0000-0000-0000-000000000014', E'EMPLOYMENT_CONTRACT', E'Employment Contract', E'EMPLOYEE', E't', E't', E't', E'14', E't'),
(E'21000000-0000-0000-0000-000000000015', E'OTHER', E'Other', E'ANY', E'f', E'f', E'f', E'99', E't');
...
INSERT INTO reference."EmploymentStatusType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'14000000-0000-0000-0000-000000000001', E'ACTIVE', E'Active', E'1', E't'),
(E'14000000-0000-0000-0000-000000000002', E'PROBATION', E'Probation', E'2', E't'),
(E'14000000-0000-0000-0000-000000000003', E'ON_LEAVE', E'On Leave', E'3', E't'),
(E'14000000-0000-0000-0000-000000000004', E'SUSPENDED', E'Suspended', E'4', E't'),
(E'14000000-0000-0000-0000-000000000005', E'RESIGNED', E'Resigned', E'5', E't'),
(E'14000000-0000-0000-0000-000000000006', E'TERMINATED', E'Terminated', E'6', E't'),
(E'14000000-0000-0000-0000-000000000007', E'RETIRED', E'Retired', E'7', E't');
...
INSERT INTO reference."EmploymentType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'15000000-0000-0000-0000-000000000001', E'PERMANENT', E'Permanent', E'1', E't'),
(E'15000000-0000-0000-0000-000000000002', E'CONTRACT', E'Contract', E'2', E't'),
(E'15000000-0000-0000-0000-000000000003', E'PART_TIME', E'Part Time', E'3', E't'),
(E'15000000-0000-0000-0000-000000000004', E'TEMPORARY', E'Temporary', E'4', E't'),
(E'15000000-0000-0000-0000-000000000005', E'INTERN', E'Intern', E'5', E't');
...
INSERT INTO reference."ExamType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'20000000-0000-0000-0000-000000000001', E'CLASS_TEST', E'Class Test', E'1', E't'),
(E'20000000-0000-0000-0000-000000000002', E'MONTHLY_TEST', E'Monthly Test', E'2', E't'),
(E'20000000-0000-0000-0000-000000000003', E'MIDTERM', E'Midterm', E'3', E't'),
(E'20000000-0000-0000-0000-000000000004', E'ANNUAL', E'Annual Examination', E'4', E't'),
(E'20000000-0000-0000-0000-000000000005', E'PRE_BOARD', E'Pre-Board', E'5', E't'),
(E'20000000-0000-0000-0000-000000000006', E'SUPPLEMENTARY', E'Supplementary', E'6', E't');
...
INSERT INTO reference."FeeStatusType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'18000000-0000-0000-0000-000000000001', E'PENDING', E'Pending', E'1', E't'),
(E'18000000-0000-0000-0000-000000000002', E'PARTIALLY_PAID', E'Partially Paid', E'2', E't'),
(E'18000000-0000-0000-0000-000000000003', E'PAID', E'Paid', E'3', E't'),
(E'18000000-0000-0000-0000-000000000004', E'OVERDUE', E'Overdue', E'4', E't'),
(E'18000000-0000-0000-0000-000000000005', E'WAIVED', E'Waived', E'5', E't'),
(E'18000000-0000-0000-0000-000000000006', E'CANCELLED', E'Cancelled', E'6', E't');
...
INSERT INTO reference."GenderType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'12000000-0000-0000-0000-000000000001', E'MALE', E'Male', E'1', E't'),
(E'12000000-0000-0000-0000-000000000002', E'FEMALE', E'Female', E'2', E't'),
(E'12000000-0000-0000-0000-000000000003', E'OTHER', E'Other', E'99', E't');
...
INSERT INTO reference."LicenseCategoryType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'23000000-0000-0000-0000-000000000001', E'LTV', E'Light Transport Vehicle', E'1', E't'),
(E'23000000-0000-0000-0000-000000000002', E'HTV', E'Heavy Transport Vehicle', E'2', E't'),
(E'23000000-0000-0000-0000-000000000003', E'PSV', E'Public Service Vehicle', E'3', E't'),
(E'23000000-0000-0000-0000-000000000004', E'OTHER', E'Other', E'99', E't');
...
INSERT INTO reference."MaritalStatusType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'16000000-0000-0000-0000-000000000001', E'SINGLE', E'Single', E'1', E't'),
(E'16000000-0000-0000-0000-000000000002', E'MARRIED', E'Married', E'2', E't'),
(E'16000000-0000-0000-0000-000000000003', E'DIVORCED', E'Divorced', E'3', E't'),
(E'16000000-0000-0000-0000-000000000004', E'WIDOWED', E'Widowed', E'4', E't');
...
INSERT INTO reference."OccupationType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'10000000-0000-0000-0000-000000000001', E'BUSINESS', E'Business Owner', E'1', E't'),
(E'10000000-0000-0000-0000-000000000002', E'PRIVATE_EMPLOYEE', E'Private Sector Employee', E'2', E't'),
(E'10000000-0000-0000-0000-000000000003', E'GOVERNMENT_EMPLOYEE', E'Government Employee', E'3', E't'),
(E'10000000-0000-0000-0000-000000000004', E'TEACHER', E'Teacher', E'4', E't'),
(E'10000000-0000-0000-0000-000000000005', E'DOCTOR', E'Doctor', E'5', E't'),
(E'10000000-0000-0000-0000-000000000006', E'ENGINEER', E'Engineer', E'6', E't'),
(E'10000000-0000-0000-0000-000000000007', E'LAWYER', E'Lawyer', E'7', E't'),
(E'10000000-0000-0000-0000-000000000008', E'SELF_EMPLOYED', E'Self Employed', E'8', E't'),
(E'10000000-0000-0000-0000-000000000009', E'HOMEMAKER', E'Homemaker', E'9', E't'),
(E'10000000-0000-0000-0000-000000000010', E'RETIRED', E'Retired', E'10', E't'),
(E'10000000-0000-0000-0000-000000000011', E'UNEMPLOYED', E'Unemployed', E'11', E't'),
(E'10000000-0000-0000-0000-000000000012', E'OTHER', E'Other', E'99', E't');
...
INSERT INTO reference."PaymentMethodType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'17000000-0000-0000-0000-000000000001', E'CASH', E'Cash', E'1', E't'),
(E'17000000-0000-0000-0000-000000000002', E'BANK_TRANSFER', E'Bank Transfer', E'2', E't'),
(E'17000000-0000-0000-0000-000000000003', E'CARD', E'Debit/Credit Card', E'3', E't'),
(E'17000000-0000-0000-0000-000000000004', E'CHEQUE', E'Cheque', E'4', E't'),
(E'17000000-0000-0000-0000-000000000005', E'ONLINE', E'Online Payment', E'5', E't'),
(E'17000000-0000-0000-0000-000000000006', E'MOBILE_WALLET', E'Mobile Wallet', E'6', E't');
...
INSERT INTO reference."RelationshipType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'11000000-0000-0000-0000-000000000001', E'FATHER', E'Father', E'1', E't'),
(E'11000000-0000-0000-0000-000000000002', E'MOTHER', E'Mother', E'2', E't'),
(E'11000000-0000-0000-0000-000000000003', E'GUARDIAN', E'Guardian', E'3', E't'),
(E'11000000-0000-0000-0000-000000000004', E'BROTHER', E'Brother', E'4', E't'),
(E'11000000-0000-0000-0000-000000000005', E'SISTER', E'Sister', E'5', E't'),
(E'11000000-0000-0000-0000-000000000006', E'GRANDFATHER', E'Grandfather', E'6', E't'),
(E'11000000-0000-0000-0000-000000000007', E'GRANDMOTHER', E'Grandmother', E'7', E't'),
(E'11000000-0000-0000-0000-000000000008', E'UNCLE', E'Uncle', E'8', E't'),
(E'11000000-0000-0000-0000-000000000009', E'AUNT', E'Aunt', E'9', E't'),
(E'11000000-0000-0000-0000-000000000010', E'OTHER', E'Other', E'99', E't');
...
INSERT INTO reference."VehicleType" ("Id", "Code", "Name", "DisplayOrder", "IsActive") VALUES
(E'22000000-0000-0000-0000-000000000001', E'BUS', E'Bus', E'1', E't'),
(E'22000000-0000-0000-0000-000000000002', E'VAN', E'Van', E'2', E't'),
(E'22000000-0000-0000-0000-000000000003', E'COASTER', E'Coaster', E'3', E't'),
(E'22000000-0000-0000-0000-000000000004', E'CAR', E'Car', E'4', E't'),
(E'22000000-0000-0000-0000-000000000005', E'OTHER', E'Other', E'99', E't');
...
INSERT INTO saas.lookup_type (lookup_type_id, code, name) OVERRIDING SYSTEM VALUE VALUES
(E'1', E'TENANT_STATUS', E'Tenant Status'),
(E'2', E'ACADEMIC_SYSTEM_TYPE', E'Academic System Type'),
(E'3', E'SUBJECT_REQUIREMENT_TYPE', E'Subject Requirement Type'),
(E'4', E'ENROLLMENT_TYPE', E'Course Enrollment Type'),
(E'5', E'EXAM_TYPE', E'Exam / Assessment Type'),
(E'6', E'ATTENDANCE_STATUS', E'Attendance Status'),
(E'7', E'ASSIGNMENT_TYPE', E'Academic Assignment Type'),
(E'8', E'WORK_ASSIGNMENT_STATUS', E'Work Assignment Status'),
(E'9', E'EMPLOYMENT_TYPE', E'Employment Type'),
(E'10', E'CANDIDATE_STATUS', E'Candidate Status'),
(E'11', E'APPLICATION_STATUS', E'Job Application Status'),
(E'12', E'INTERVIEW_TYPE', E'Interview Type'),
(E'13', E'DOCUMENT_TYPE', E'Certificate / Letter Type'),
(E'14', E'INCREMENT_REQUEST_TYPE', E'Increment Request Type'),
(E'15', E'INCREMENT_TYPE', E'Increment Type'),
(E'16', E'APPROVAL_STATUS', E'Approval Status'),
(E'17', E'PAYROLL_STATUS', E'Payroll Status'),
(E'18', E'MESSAGE_TYPE', E'Message Type'),
(E'19', E'CONVERSATION_TYPE', E'Conversation Type'),
(E'20', E'AWARD_TYPE', E'Award Type'),
(E'21', E'NOTIFICATION_CHANNEL', E'Notification Channel');
...
INSERT INTO saas.lookup_value (lookup_value_id, lookup_type_id, code, name, sort_order, is_active, metadata) OVERRIDING SYSTEM VALUE VALUES
(E'1', E'1', E'TRIAL', E'Trial', E'1', E't', NULL),
(E'2', E'1', E'ACTIVE', E'Active', E'2', E't', NULL),
(E'3', E'1', E'SUSPENDED', E'Suspended', E'3', E't', NULL),
(E'4', E'1', E'CANCELLED', E'Cancelled', E'4', E't', NULL),
(E'5', E'2', E'CAMBRIDGE', E'Cambridge', E'1', E't', NULL),
(E'6', E'2', E'MATRIC', E'Matric / SSC', E'2', E't', NULL),
(E'7', E'2', E'INTERMEDIATE', E'Intermediate / HSSC', E'3', E't', NULL),
(E'8', E'2', E'IB', E'International Baccalaureate', E'4', E't', NULL),
(E'9', E'2', E'AMERICAN', E'American', E'5', E't', NULL),
(E'10', E'2', E'CUSTOM', E'Custom', E'99', E't', NULL),
(E'11', E'3', E'MANDATORY', E'Mandatory', E'1', E't', NULL),
(E'12', E'3', E'OPTIONAL', E'Optional', E'2', E't', NULL),
(E'13', E'3', E'ELECTIVE', E'Elective', E'3', E't', NULL),
(E'14', E'4', E'MANDATORY', E'Mandatory', E'1', E't', NULL),
(E'15', E'4', E'ELECTIVE', E'Elective', E'2', E't', NULL),
(E'16', E'4', E'OPTIONAL', E'Optional', E'3', E't', NULL),
(E'17', E'4', E'TRANSFERRED', E'Transferred', E'4', E't', NULL),
(E'18', E'5', E'QUIZ', E'Quiz', E'1', E't', NULL),
(E'19', E'5', E'CLASS_TEST', E'Class Test', E'2', E't', NULL),
(E'20', E'5', E'WEEKLY_TEST', E'Weekly Test', E'3', E't', NULL),
(E'21', E'5', E'MONTHLY_TEST', E'Monthly Test', E'4', E't', NULL),
(E'22', E'5', E'UNIT_TEST', E'Unit / Chapter Test', E'5', E't', NULL),
(E'23', E'5', E'MIDTERM', E'Midterm', E'6', E't', NULL),
(E'24', E'5', E'TERM', E'Term Examination', E'7', E't', NULL),
(E'25', E'5', E'PREBOARD', E'Pre-Board', E'8', E't', NULL),
(E'26', E'5', E'MOCK', E'Mock Examination', E'9', E't', NULL),
(E'27', E'5', E'ANNUAL', E'Annual Examination', E'10', E't', NULL),
(E'28', E'5', E'FINAL', E'Final Examination', E'11', E't', NULL),
(E'29', E'5', E'PRACTICAL', E'Practical', E'12', E't', NULL),
(E'30', E'5', E'VIVA', E'Oral / Viva', E'13', E't', NULL),
(E'31', E'5', E'PROJECT', E'Project / Coursework', E'14', E't', NULL),
(E'32', E'5', E'SUPPLEMENTARY', E'Supplementary', E'15', E't', NULL),
(E'33', E'5', E'RESIT', E'Re-sit', E'16', E't', NULL),
(E'34', E'6', E'PRESENT', E'Present', E'1', E't', NULL),
(E'35', E'6', E'ABSENT', E'Absent', E'2', E't', NULL),
(E'36', E'6', E'LATE', E'Late', E'3', E't', NULL),
(E'37', E'6', E'EXCUSED', E'Excused', E'4', E't', NULL),
(E'38', E'6', E'LEAVE', E'Leave', E'5', E't', NULL),
(E'39', E'6', E'HALF_DAY', E'Half Day', E'6', E't', NULL),
(E'40', E'7', E'HOMEWORK', E'Homework', E'1', E't', NULL),
(E'41', E'7', E'CLASSWORK', E'Classwork', E'2', E't', NULL),
(E'42', E'7', E'PROJECT', E'Project', E'3', E't', NULL),
(E'43', E'7', E'RESEARCH', E'Research', E'4', E't', NULL),
(E'44', E'7', E'PRESENTATION', E'Presentation', E'5', E't', NULL),
(E'45', E'7', E'PRACTICAL', E'Practical', E'6', E't', NULL),
(E'46', E'7', E'LAB_WORK', E'Lab Work', E'7', E't', NULL),
(E'47', E'7', E'ESSAY', E'Essay', E'8', E't', NULL),
(E'48', E'7', E'READING', E'Reading', E'9', E't', NULL),
(E'49', E'7', E'GROUP_WORK', E'Group Work', E'10', E't', NULL),
(E'50', E'7', E'HOLIDAY_HOMEWORK', E'Holiday Homework', E'11', E't', NULL),
(E'51', E'7', E'CUSTOM', E'Custom', E'99', E't', NULL),
(E'52', E'8', E'DRAFT', E'Draft', E'1', E't', NULL),
(E'53', E'8', E'ASSIGNED', E'Assigned', E'2', E't', NULL),
(E'54', E'8', E'ACCEPTED', E'Accepted', E'3', E't', NULL),
(E'55', E'8', E'IN_PROGRESS', E'In Progress', E'4', E't', NULL),
(E'56', E'8', E'BLOCKED', E'Blocked', E'5', E't', NULL),
(E'57', E'8', E'COMPLETED', E'Completed', E'6', E't', NULL),
(E'58', E'8', E'REJECTED', E'Rejected', E'7', E't', NULL),
(E'59', E'8', E'CANCELLED', E'Cancelled', E'8', E't', NULL),
(E'60', E'8', E'OVERDUE', E'Overdue', E'9', E't', NULL),
(E'61', E'9', E'PERMANENT', E'Permanent', E'1', E't', NULL),
(E'62', E'9', E'CONTRACT', E'Contract', E'2', E't', NULL),
(E'63', E'9', E'PART_TIME', E'Part Time', E'3', E't', NULL),
(E'64', E'9', E'TEMPORARY', E'Temporary', E'4', E't', NULL),
(E'65', E'9', E'VISITING', E'Visiting', E'5', E't', NULL),
(E'66', E'9', E'INTERN', E'Intern', E'6', E't', NULL),
(E'67', E'10', E'NEW', E'New', E'1', E't', NULL),
(E'68', E'10', E'SCREENING', E'Screening', E'2', E't', NULL),
(E'69', E'10', E'SHORTLISTED', E'Shortlisted', E'3', E't', NULL),
(E'70', E'10', E'INTERVIEW', E'Interview', E'4', E't', NULL),
(E'71', E'10', E'ASSESSMENT', E'Assessment', E'5', E't', NULL),
(E'72', E'10', E'SELECTED', E'Selected', E'6', E't', NULL),
(E'73', E'10', E'OFFER', E'Offer', E'7', E't', NULL),
(E'74', E'10', E'HIRED', E'Hired', E'8', E't', NULL),
(E'75', E'10', E'REJECTED', E'Rejected', E'9', E't', NULL),
(E'76', E'10', E'WITHDRAWN', E'Withdrawn', E'10', E't', NULL),
(E'77', E'10', E'ON_HOLD', E'On Hold', E'11', E't', NULL),
(E'78', E'11', E'APPLIED', E'Applied', E'1', E't', NULL),
(E'79', E'11', E'SCREENING', E'Screening', E'2', E't', NULL),
(E'80', E'11', E'SHORTLISTED', E'Shortlisted', E'3', E't', NULL),
(E'81', E'11', E'INTERVIEW', E'Interview', E'4', E't', NULL),
(E'82', E'11', E'OFFERED', E'Offered', E'5', E't', NULL),
(E'83', E'11', E'HIRED', E'Hired', E'6', E't', NULL),
(E'84', E'11', E'REJECTED', E'Rejected', E'7', E't', NULL),
(E'85', E'11', E'WITHDRAWN', E'Withdrawn', E'8', E't', NULL),
(E'86', E'12', E'HR_SCREENING', E'HR Screening', E'1', E't', NULL),
(E'87', E'12', E'SUBJECT', E'Subject / Technical Interview', E'2', E't', NULL),
(E'88', E'12', E'TEACHING_DEMO', E'Teaching Demo', E'3', E't', NULL),
(E'89', E'12', E'PANEL', E'Panel Interview', E'4', E't', NULL),
(E'90', E'12', E'PRINCIPAL', E'Principal Interview', E'5', E't', NULL),
(E'91', E'12', E'FINAL', E'Final Interview', E'6', E't', NULL),
(E'92', E'13', E'SCHOOL_LEAVING', E'School Leaving Certificate', E'1', E't', NULL),
(E'93', E'13', E'TRANSFER', E'Transfer Certificate', E'2', E't', NULL),
(E'94', E'13', E'MIGRATION', E'Migration Certificate', E'3', E't', NULL),
(E'95', E'13', E'CHARACTER', E'Character / Conduct Certificate', E'4', E't', NULL),
(E'96', E'13', E'BONAFIDE', E'Bonafide / Enrollment Certificate', E'5', E't', NULL),
(E'97', E'13', E'APPRECIATION', E'Appreciation Certificate', E'6', E't', NULL),
(E'98', E'13', E'STUDENT_OF_MONTH', E'Student of the Month Certificate', E'7', E't', NULL),
(E'99', E'13', E'ACHIEVEMENT', E'Achievement Certificate', E'8', E't', NULL),
(E'100', E'13', E'SPORTS', E'Sports Certificate', E'9', E't', NULL),
(E'101', E'13', E'ACTIVITY', E'Co-curricular Activity Certificate', E'10', E't', NULL),
(E'102', E'13', E'ADMISSION_OFFER', E'Admission Offer Letter', E'11', E't', NULL),
(E'103', E'13', E'WARNING', E'Warning Letter', E'12', E't', NULL),
(E'104', E'13', E'EMPLOYMENT', E'Employment Letter', E'13', E't', NULL),
(E'105', E'13', E'EXPERIENCE', E'Experience Letter', E'14', E't', NULL),
(E'106', E'13', E'CUSTOM', E'Custom Document', E'99', E't', NULL),
(E'107', E'14', E'AUTO', E'Automatic Proposal', E'1', E't', NULL),
(E'108', E'14', E'MANUAL', E'Manual Proposal', E'2', E't', NULL),
(E'109', E'15', E'PERCENTAGE', E'Percentage', E'1', E't', NULL),
(E'110', E'15', E'FIXED', E'Fixed Amount', E'2', E't', NULL),
(E'111', E'15', E'NEW_SALARY', E'New Salary', E'3', E't', NULL),
(E'112', E'15', E'GRADE_STEP', E'Grade / Step', E'4', E't', NULL),
(E'113', E'16', E'DRAFT', E'Draft', E'1', E't', NULL),
(E'114', E'16', E'PENDING', E'Pending', E'2', E't', NULL),
(E'115', E'16', E'APPROVED', E'Approved', E'3', E't', NULL),
(E'116', E'16', E'REJECTED', E'Rejected', E'4', E't', NULL),
(E'117', E'16', E'CANCELLED', E'Cancelled', E'5', E't', NULL),
(E'118', E'17', E'DRAFT', E'Draft', E'1', E't', NULL),
(E'119', E'17', E'CALCULATED', E'Calculated', E'2', E't', NULL),
(E'120', E'17', E'HR_REVIEW', E'HR Review', E'3', E't', NULL),
(E'121', E'17', E'FINANCE_REVIEW', E'Finance Review', E'4', E't', NULL),
(E'122', E'17', E'APPROVED', E'Approved', E'5', E't', NULL),
(E'123', E'17', E'LOCKED', E'Locked', E'6', E't', NULL),
(E'124', E'17', E'PAID', E'Paid', E'7', E't', NULL),
(E'125', E'18', E'TEXT', E'Text', E'1', E't', NULL),
(E'126', E'18', E'IMAGE', E'Image', E'2', E't', NULL),
(E'127', E'18', E'FILE', E'File', E'3', E't', NULL),
(E'128', E'18', E'VOICE', E'Voice Note', E'4', E't', NULL),
(E'129', E'18', E'SYSTEM', E'System', E'5', E't', NULL),
(E'130', E'19', E'PARENT_TEACHER', E'Parent / Teacher', E'1', E't', NULL),
(E'131', E'19', E'CLASS', E'Class Channel', E'2', E't', NULL),
(E'132', E'19', E'SUBJECT', E'Subject Channel', E'3', E't', NULL),
(E'133', E'19', E'ADMIN', E'Administration', E'4', E't', NULL),
(E'134', E'19', E'STAFF', E'Staff', E'5', E't', NULL),
(E'135', E'20', E'STUDENT_OF_MONTH', E'Student of the Month', E'1', E't', NULL),
(E'136', E'20', E'ACADEMIC_EXCELLENCE', E'Academic Excellence', E'2', E't', NULL),
(E'137', E'20', E'BEST_ATTENDANCE', E'Best Attendance', E'3', E't', NULL),
(E'138', E'20', E'MOST_IMPROVED', E'Most Improved', E'4', E't', NULL),
(E'139', E'20', E'LEADERSHIP', E'Leadership', E'5', E't', NULL),
(E'140', E'20', E'SPORTS_EXCELLENCE', E'Sports Excellence', E'6', E't', NULL),
(E'141', E'20', E'COMMUNITY_SERVICE', E'Community Service', E'7', E't', NULL),
(E'142', E'20', E'APPRECIATION', E'Appreciation', E'8', E't', NULL),
(E'143', E'21', E'IN_APP', E'In-App', E'1', E't', NULL),
(E'144', E'21', E'PUSH', E'Push', E'2', E't', NULL),
(E'145', E'21', E'EMAIL', E'Email', E'3', E't', NULL),
(E'146', E'21', E'SMS', E'SMS', E'4', E't', NULL),
(E'147', E'21', E'WHATSAPP', E'WhatsApp', E'5', E't', NULL);
...
-- ===== POST-V87 CAMPUS/DOMAIN ALIGNMENTS =====
...
ALTER TABLE IF EXISTS identity."AspNetUsers" ADD COLUMN IF NOT EXISTS "BranchId" uuid;
...
ALTER TABLE exam.grade_scale ADD COLUMN IF NOT EXISTS campus_id uuid;
ALTER TABLE exam.grade_scale ADD COLUMN IF NOT EXISTS minimum_percentage numeric(5,2) NOT NULL DEFAULT 0;
ALTER TABLE exam.grade_scale ADD COLUMN IF NOT EXISTS maximum_percentage numeric(5,2) NOT NULL DEFAULT 100;
ALTER TABLE exam.grade_scale ADD COLUMN IF NOT EXISTS grade_point numeric(5,2);
ALTER TABLE exam.grade_scale ADD COLUMN IF NOT EXISTS description text;
CREATE INDEX IF NOT EXISTS ix_grade_scale_campus ON exam.grade_scale(tenant_id, campus_id);

COMMIT;

-- SOURCE: database/postgresql/20260908_remove_academic_section.sql
BEGIN;
...
-- SOURCE: database/postgresql/20260908_subject_department_teaching_assignment.sql
BEGIN;
...
-- SOURCE: database/postgresql/20260909_central_document_model.sql
...
-- SOURCE: database/postgresql/20260909_remove_legacy_document_artifacts.sql
BEGIN;
...
-- SOURCE: database/postgresql/20260909_campus_scope_schema_sync.sql
...
-- 20260903 enum architecture alignment
BEGIN;
...
-- BEGIN V124__remaining_operational_workflows.sql
...
-- END V124__remaining_operational_workflows.sql


-- BEGIN V125__examiner_subject_tasks.sql
-- SmartSchool V125
