...
CREATE TABLE finance.fee_type (
    ...
    code character varying(100) NOT NULL,
    name character varying(250) NOT NULL,
    frequency character varying(30) DEFAULT 'Monthly' NOT NULL,
...
CREATE TABLE hr.employee (
    ...
    branch_id uuid,
    department_id uuid,
    staff_type character varying(30) DEFAULT 'OTHER'::character varying NOT NULL,
    designation smallint DEFAULT 0 NOT NULL,
    date_of_birth date,
