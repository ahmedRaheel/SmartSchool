...
public static class WorkflowCatalogEndpoints
{
    ...
    [
        ...
        new("CLASS_TEST","Class Test",[SmartSchoolRoles.Teacher],[SmartSchoolRoles.Teacher],
            ["Draft","AssignmentValidation","ScheduleCheck","Publish","Submission","Marking","PublishResult","PredictionRefresh"]),
        new("STUDENT_LEAVE","Student Leave",[SmartSchoolRoles.Student,SmartSchoolRoles.Parent],[SmartSchoolRoles.Teacher,"SchoolAdmin"],
            ["Request","Validate","Approval","AttendanceUpdate","TransportUpdate","Notify"]),
        new("TEACHER_LEAVE","Teacher Leave",[SmartSchoolRoles.Teacher],["SchoolAdmin","Principal"],
        ...
        new("FEE_CONCESSION","Fee Concession / Waiver",["SchoolAdmin",SmartSchoolRoles.Parent],["SchoolAdmin","Accountant"],
        ...
        new("STUDENT_WITHDRAWAL","Student Withdrawal / Transfer",[SmartSchoolRoles.Parent,"SchoolAdmin"],["SchoolAdmin","Principal"],
            ["Request","Clearance","Approval","Documents","CloseEnrollment","AccountUpdate","Notify"]),
        new("NOTICE_PUBLICATION","Document / Notice Publication",[SmartSchoolRoles.Teacher,"SchoolAdmin","Principal"],["SchoolAdmin","Principal"],
            ["Draft","Audience","Approval","Publish","NotificationFanout","ReadReceipt"]),
        new("TIMETABLE_CHANGE","Timetable Change",[SmartSchoolRoles.Teacher,"SchoolAdmin"],["SchoolAdmin","Principal"],
            ["Request","ConflictCheck","WorkloadValidation","Approval","Apply","Notify"]),
        new("TRANSPORT_ASSIGNMENT","Transport Assignment / Change",[SmartSchoolRoles.Parent,"SchoolAdmin"],["SchoolAdmin","TransportManager"],
