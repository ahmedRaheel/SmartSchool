...
public static class CreateApproval
{
    ...
    public sealed class Handler(ICreateApprovalCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Approval", "APP", request.TenantId, 3, cancellationToken);
