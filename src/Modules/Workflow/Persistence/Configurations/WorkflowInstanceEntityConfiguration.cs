...
/// <summary>
/// Defines relational persistence rules for <see cref="WorkflowInstanceEntity"/>.
/// </summary>
public sealed class WorkflowInstanceEntityConfiguration
	: IEntityTypeConfiguration<WorkflowInstanceEntity>
{
