...
public static class GetCampusBrandingPage
{
	...
	public interface IGetCampusBrandingPage
	{
	...
	internal sealed class GetCampusBrandingPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetCampusBrandingPage
	{
	...
	public sealed class Handler(IGetCampusBrandingPage dataAccess)
