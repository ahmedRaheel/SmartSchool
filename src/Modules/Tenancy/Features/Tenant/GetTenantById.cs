...
public static class GetTenantById
{
	...
	internal sealed class GetTenantByIdPersistence(
		IDbConnectionFactory connectionFactory) : IGetTenantById
	{
	...
	public sealed class Handler(IGetTenantById dataAccess)
