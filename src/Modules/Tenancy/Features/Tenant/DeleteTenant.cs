...
public static class DeleteTenant
{
	...
	public interface IDeleteTenant
	{
		Task DeleteAsync(
				TenantEntity entity,
	...
	internal sealed class DeleteTenantDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IDeleteTenant
	{
	...
	public sealed class Handler(IDeleteTenant dataAccess)
