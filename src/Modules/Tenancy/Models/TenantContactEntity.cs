...
public sealed class TenantContactEntity : Entity
{
    ...
    public static TenantContactEntity CreatePrimary(Guid tenantId, string name, string email, string phone, string address) => new() { TenantId=tenantId, ContactName=name.Trim(), Email=email.Trim(), Phone=phone.Trim(), AddressLine1=address.Trim() };
}
