...
public static class GetGeneratedDocumentByStudentId
{
    ...
    public interface IGetGeneratedDocumentByStudentIdQuery
    {
    ...
    internal sealed class GetGeneratedDocumentByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetGeneratedDocumentByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetGeneratedDocumentByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/documents/generated-document/by-student/{parentId:guid}",
            ...
            .WithName("GetGeneratedDocumentByStudentId")
            .WithTags("Documents")
