...
public static class CreateGeneratedDocument
{
    ...
    public sealed class Handler(ICreateGeneratedDocumentCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("GeneratedDocument", "GD", request.TenantId, 3, cancellationToken);
