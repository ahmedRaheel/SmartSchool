...
public static class GetGeneratedDocumentByEmployeeId
{
    ...
    public interface IGetGeneratedDocumentByEmployeeIdQuery
    {
    ...
    internal sealed class GetGeneratedDocumentByEmployeeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetGeneratedDocumentByEmployeeIdQuery
    {
    ...
    public sealed class Handler(IGetGeneratedDocumentByEmployeeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/documents/generated-document/by-employee/{parentId:guid}",
            ...
            .WithName("GetGeneratedDocumentByEmployeeId")
            .WithTags("Documents")
