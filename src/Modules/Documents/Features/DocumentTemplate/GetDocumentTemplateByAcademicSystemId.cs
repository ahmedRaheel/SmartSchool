...
public static class GetDocumentTemplateByAcademicSystemId
{
    ...
    public interface IGetDocumentTemplateByAcademicSystemIdQuery
    {
    ...
    internal sealed class GetDocumentTemplateByAcademicSystemIdQuery(IDbConnectionFactory connectionFactory)
        : IGetDocumentTemplateByAcademicSystemIdQuery
    {
    ...
    public sealed class Handler(IGetDocumentTemplateByAcademicSystemIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/documents/document-template/by-academic-system/{parentId:guid}",
            ...
            .WithName("GetDocumentTemplateByAcademicSystemId")
            .WithTags("Documents")
