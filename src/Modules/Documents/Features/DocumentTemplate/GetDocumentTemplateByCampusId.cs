...
public static class GetDocumentTemplateByCampusId
{
    ...
    public interface IGetDocumentTemplateByCampusIdQuery
    {
    ...
    internal sealed class GetDocumentTemplateByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetDocumentTemplateByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetDocumentTemplateByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/documents/document-template/by-campus/{parentId:guid}",
            ...
            .WithName("GetDocumentTemplateByCampusId")
            .WithTags("Documents")
