...
public static class CreateDocumentTemplate
{
    ...
    public interface ICreateDocumentTemplateCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreateDocumentTemplateCommand(IDocumentsDbContext dbContext) : ICreateDocumentTemplateCommand
    {
    ...
    public sealed class Handler(ICreateDocumentTemplateCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("DocumentTemplate", "DT", request.TenantId, 3, cancellationToken);
