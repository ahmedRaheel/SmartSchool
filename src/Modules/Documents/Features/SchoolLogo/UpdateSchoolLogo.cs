...
public static class UpdateSchoolLogo
{
    ...
    public interface IUpdateSchoolLogoCommand
    {
        Task UpdateAsync(
...
Task<SchoolLogoEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateSchoolLogoCommand(IDocumentsDbContext dbContext) : IUpdateSchoolLogoCommand
    {
    ...
    public sealed class Handler(IUpdateSchoolLogoCommand command)
