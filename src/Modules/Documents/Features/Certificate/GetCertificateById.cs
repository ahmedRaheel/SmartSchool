...
public static class GetCertificateById
{
    ...
    public interface IGetCertificateByIdQuery
    {
    ...
    internal sealed class GetCertificateByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetCertificateByIdQuery
    {
    ...
    public sealed class Handler(IGetCertificateByIdQuery query)
