...
public static class GetCertificatePage
{
    ...
    public interface IGetCertificatePageQuery
    {
    ...
    internal sealed class GetCertificatePageQuery(
        IDbConnectionFactory connectionFactory) : IGetCertificatePageQuery
    {
    ...
    public sealed class Handler(IGetCertificatePageQuery query)
