...
/// <summary>
/// Defines relational persistence rules for <see cref="CertificateEntity"/>.
/// </summary>
public sealed class CertificateEntityConfiguration
	: IEntityTypeConfiguration<CertificateEntity>
{
	public void Configure(EntityTypeBuilder<CertificateEntity> builder)
	{
		...
		builder.Property(entity => entity.CertificateId).HasColumnName("certificate_id");
	}
}
