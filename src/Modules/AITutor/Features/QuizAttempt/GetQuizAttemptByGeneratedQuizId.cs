...
public static class GetQuizAttemptByGeneratedQuizId
{
    ...
    public interface IGetQuizAttemptByGeneratedQuizIdQuery
    {
    ...
    internal sealed class GetQuizAttemptByGeneratedQuizIdQuery(IDbConnectionFactory connectionFactory)
        : IGetQuizAttemptByGeneratedQuizIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE tenant_id = @TenantId
                      AND entity.generated_quiz_id = @ParentId
                      AND is_active = TRUE;
                    """;
    ...
    public sealed class Handler(IGetQuizAttemptByGeneratedQuizIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/student-quiz-attempt/by-generated-quiz/{parentId:guid}",
            ...
            .WithName("GetQuizAttemptByGeneratedQuizId")
            .WithTags("AITutor")
