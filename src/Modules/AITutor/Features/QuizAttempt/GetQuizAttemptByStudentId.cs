...
public static class GetQuizAttemptByStudentId
{
    ...
    public interface IGetQuizAttemptByStudentIdQuery
    {
    ...
    internal sealed class GetQuizAttemptByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetQuizAttemptByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetQuizAttemptByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/student-quiz-attempt/by-student/{parentId:guid}",
            ...
            .WithName("GetQuizAttemptByStudentId")
            .WithTags("AITutor")
