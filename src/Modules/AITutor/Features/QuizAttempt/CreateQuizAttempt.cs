...
public static class CreateQuizAttempt
{
    ...
    public interface ICreateQuizAttemptCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreateQuizAttemptCommand(IAITutorDbContext dbContext) : ICreateQuizAttemptCommand
    {
    ...
    public sealed class Handler(ICreateQuizAttemptCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("QuizAttempt", "QA", request.TenantId, 3, cancellationToken);
