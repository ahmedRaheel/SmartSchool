...
public static class GetTutorConversationByAcademicYearId
{
    ...
    public interface IGetTutorConversationByAcademicYearIdQuery
    {
    ...
    internal sealed class GetTutorConversationByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorConversationByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetTutorConversationByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-conversation/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetTutorConversationByAcademicYearId")
            .WithTags("AITutor")
