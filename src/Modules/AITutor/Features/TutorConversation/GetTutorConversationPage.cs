...
public static class GetTutorConversationPage
{
    ...
    public interface IGetTutorConversationPage
    {
    ...
    internal sealed class GetTutorConversationPagePersistence(
        IDbConnectionFactory connectionFactory) : IGetTutorConversationPage
    {
    ...
    public sealed class Handler(IGetTutorConversationPage dataAccess)
