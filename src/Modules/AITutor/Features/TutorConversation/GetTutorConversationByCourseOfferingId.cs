...
public static class GetTutorConversationByCourseOfferingId
{
    ...
    public interface IGetTutorConversationByCourseOfferingIdQuery
    {
    ...
    internal sealed class GetTutorConversationByCourseOfferingIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorConversationByCourseOfferingIdQuery
    {
    ...
    public sealed class Handler(IGetTutorConversationByCourseOfferingIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-conversation/by-course-offering/{parentId:guid}",
            ...
            .WithName("GetTutorConversationByCourseOfferingId")
            .WithTags("AITutor")
