...
public static class GetTutorConversationBySubjectId
{
    ...
    public interface IGetTutorConversationBySubjectIdQuery
    {
    ...
    internal sealed class GetTutorConversationBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorConversationBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetTutorConversationBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-conversation/by-subject/{parentId:guid}",
            ...
            .WithName("GetTutorConversationBySubjectId")
            .WithTags("AITutor")
