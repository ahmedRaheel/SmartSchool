...
public static class GetTutorConversationByStudentId
{
    ...
    public interface IGetTutorConversationByStudentIdQuery
    {
    ...
    internal sealed class GetTutorConversationByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorConversationByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetTutorConversationByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-conversation/by-student/{parentId:guid}",
            ...
            .WithName("GetTutorConversationByStudentId")
            .WithTags("AITutor")
