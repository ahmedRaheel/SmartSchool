...
public static class GetGeneratedQuizBySubjectId
{
    ...
    public interface IGetGeneratedQuizBySubjectIdQuery
    {
    ...
    internal sealed class GetGeneratedQuizBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetGeneratedQuizBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetGeneratedQuizBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/generated-quiz/by-subject/{parentId:guid}",
            ...
            .WithName("GetGeneratedQuizBySubjectId")
            .WithTags("AITutor")
