...
public static class GetGeneratedQuizByTutorConversationId
{
    ...
    public interface IGetGeneratedQuizByTutorConversationIdQuery
    {
    ...
    internal sealed class GetGeneratedQuizByTutorConversationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetGeneratedQuizByTutorConversationIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.tutor_conversation_id = @ParentId
    ...
    public sealed class Handler(IGetGeneratedQuizByTutorConversationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/generated-quiz/by-tutor-conversation/{parentId:guid}",
            ...
            .WithName("GetGeneratedQuizByTutorConversationId")
            .WithTags("AITutor")
