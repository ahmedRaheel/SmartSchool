...
public static class GetLearningRecommendationBySubjectId
{
    ...
    public interface IGetLearningRecommendationBySubjectIdQuery
    {
    ...
    internal sealed class GetLearningRecommendationBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetLearningRecommendationBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetLearningRecommendationBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/learning-recommendation/by-subject/{parentId:guid}",
            ...
            .WithName("GetLearningRecommendationBySubjectId")
            .WithTags("AITutor")
