...
public static class GetTutorSessionPage
{
    ...
    public interface IGetTutorSessionPageQuery
    {
    ...
    internal sealed class GetTutorSessionPageQuery(
        IDbConnectionFactory connectionFactory) : IGetTutorSessionPageQuery
    {
    ...
    public sealed class Handler(IGetTutorSessionPageQuery query)
