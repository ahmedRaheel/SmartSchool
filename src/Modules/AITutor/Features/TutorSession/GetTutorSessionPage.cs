...
public static class GetTutorSessionPage
{
	...
	public interface IGetTutorSessionPage
	{
	...
	internal sealed class GetTutorSessionPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetTutorSessionPage
	{
	...
	public sealed class Handler(IGetTutorSessionPage dataAccess)
