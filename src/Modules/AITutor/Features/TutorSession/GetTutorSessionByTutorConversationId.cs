...
public static class GetTutorSessionByTutorConversationId
{
    ...
    public interface IGetTutorSessionByTutorConversationIdQuery
    {
    ...
    internal sealed class GetTutorSessionByTutorConversationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorSessionByTutorConversationIdQuery
    {
    ...
    public sealed class Handler(IGetTutorSessionByTutorConversationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-session/by-tutor-conversation/{parentId:guid}",
            ...
            .WithName("GetTutorSessionByTutorConversationId")
            .WithTags("AITutor")
