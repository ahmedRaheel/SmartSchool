...
public static class UpdateTutorMessage
{
    ...
    public interface IUpdateTutorMessageCommand
    {
        Task UpdateAsync(
...
Task<TutorMessageEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateTutorMessageCommand(IAITutorDbContext dbContext) : IUpdateTutorMessageCommand
    {
    ...
    public sealed class Handler(IUpdateTutorMessageCommand command)
