...
public static class GetTutorMessageByTutorConversationId
{
    ...
    public interface IGetTutorMessageByTutorConversationIdQuery
    {
    ...
    internal sealed class GetTutorMessageByTutorConversationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTutorMessageByTutorConversationIdQuery
    {
    ...
    public sealed class Handler(IGetTutorMessageByTutorConversationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/tutor-message/by-tutor-conversation/{parentId:guid}",
            ...
            .WithName("GetTutorMessageByTutorConversationId")
            .WithTags("AITutor")
