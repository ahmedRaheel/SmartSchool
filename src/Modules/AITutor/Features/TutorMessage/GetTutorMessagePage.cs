...
public static class GetTutorMessagePage
{
    ...
    public interface IGetTutorMessagePageQuery
    {
    ...
    internal sealed class GetTutorMessagePageQuery(
        IDbConnectionFactory connectionFactory) : IGetTutorMessagePageQuery
    {
        public async Task<PagedResult<Response>> GetPageAsync(
                ...
                CancellationToken cancellationToken)
            {
                ...
                const string pageSql = """
                    ...
                    WHERE tenant_id = @TenantId
                      AND is_active = TRUE
                    ORDER BY entity.tutor_message_id
    ...
    public sealed class Handler(IGetTutorMessagePageQuery query)
