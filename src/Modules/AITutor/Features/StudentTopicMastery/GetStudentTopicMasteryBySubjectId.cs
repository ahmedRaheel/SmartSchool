...
public static class GetStudentTopicMasteryBySubjectId
{
    ...
    public interface IGetStudentTopicMasteryBySubjectIdQuery
    {
    ...
    internal sealed class GetStudentTopicMasteryBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentTopicMasteryBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetStudentTopicMasteryBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/student-topic-mastery/by-subject/{parentId:guid}",
            ...
            .WithName("GetStudentTopicMasteryBySubjectId")
            .WithTags("AITutor")
