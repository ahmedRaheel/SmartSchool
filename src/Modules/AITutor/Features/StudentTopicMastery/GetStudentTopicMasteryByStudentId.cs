...
public static class GetStudentTopicMasteryByStudentId
{
    ...
    public interface IGetStudentTopicMasteryByStudentIdQuery
    {
    ...
    internal sealed class GetStudentTopicMasteryByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentTopicMasteryByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetStudentTopicMasteryByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aitutor/student-topic-mastery/by-student/{parentId:guid}",
            ...
            .WithName("GetStudentTopicMasteryByStudentId")
            .WithTags("AITutor")
