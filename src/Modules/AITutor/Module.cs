...
public static class Module
{
        ...
        this IEndpointRouteBuilder endpoints)
    {
        ...
        GetGeneratedQuizByTutorConversationId.MapEndpoint(endpoints);
        GetGeneratedQuizBySubjectId.MapEndpoint(endpoints);
        GetGeneratedQuizByStudentId.MapEndpoint(endpoints);
        ...
        GetLearningRecommendationBySubjectId.MapEndpoint(endpoints);
        GetLearningRecommendationByStudentId.MapEndpoint(endpoints);
        ...
        GetQuizAttemptByStudentId.MapEndpoint(endpoints);
        GetQuizAttemptByGeneratedQuizId.MapEndpoint(endpoints);
        ...
        GetStudentTopicMasteryBySubjectId.MapEndpoint(endpoints);
        GetStudentTopicMasteryByStudentId.MapEndpoint(endpoints);
        ...
        GetTutorConversationBySubjectId.MapEndpoint(endpoints);
        GetTutorConversationByStudentId.MapEndpoint(endpoints);
        GetTutorConversationByCourseOfferingId.MapEndpoint(endpoints);
        GetTutorConversationByAcademicYearId.MapEndpoint(endpoints);
        ...
        GetTutorMessageByTutorConversationId.MapEndpoint(endpoints);
        ...
        GetTutorSessionByTutorConversationId.MapEndpoint(endpoints);
