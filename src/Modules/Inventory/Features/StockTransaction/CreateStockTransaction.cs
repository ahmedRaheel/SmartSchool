...
public static class CreateStockTransaction
{
	...
	internal sealed class CreateStockTransactionDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateStockTransaction
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(StockTransactionEntity), request.Code)));
			}
