...
public static class GetStockTransactionPage
{
    ...
    public interface IGetStockTransactionPageQuery
    {
    ...
    internal sealed class GetStockTransactionPageQuery(
        IDbConnectionFactory connectionFactory) : IGetStockTransactionPageQuery
    {
        public async Task<PagedResult<Response>> GetPageAsync(
                ...
                CancellationToken cancellationToken)
            {
                ...
                const string pageSql = """
                    ...
                    FROM inventory.stock_transaction entity
                    WHERE entity.tenant_id = @TenantId
                      AND entity.is_active = TRUE
                    ORDER BY entity.stock_transaction_id
    ...
    public sealed class Handler(IGetStockTransactionPageQuery query)
