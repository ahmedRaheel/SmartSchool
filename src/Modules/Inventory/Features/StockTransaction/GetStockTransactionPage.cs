...
public static class GetStockTransactionPage
{
	...
	public interface IGetStockTransactionPage
	{
	...
	internal sealed class GetStockTransactionPageDataAccess(
	...
	public sealed class Handler(IGetStockTransactionPage dataAccess)
