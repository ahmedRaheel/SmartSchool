...
public static class UpdatePurchaseOrder
{
    ...
    public interface IUpdatePurchaseOrderCommand
    {
        Task UpdateAsync(
...
Task<PurchaseOrderEntity?> GetByIdAsync(
    ...
    internal sealed class UpdatePurchaseOrderCommand(IInventoryDbContext dbContext) : IUpdatePurchaseOrderCommand
    {
    ...
    public sealed class Handler(IUpdatePurchaseOrderCommand command)
