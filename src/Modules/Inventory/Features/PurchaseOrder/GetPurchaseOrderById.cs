...
public static class GetPurchaseOrderById
{
    ...
    public interface IGetPurchaseOrderByIdQuery
    {
    ...
    internal sealed class GetPurchaseOrderByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetPurchaseOrderByIdQuery
    {
    ...
    public sealed class Handler(IGetPurchaseOrderByIdQuery query)
