...
public static class GetItemPage
{
    ...
    internal sealed class GetItemPagePersistence(
        IDbConnectionFactory connectionFactory) : IGetItemPage
    {
    ...
    public sealed class Handler(IGetItemPage dataAccess)
