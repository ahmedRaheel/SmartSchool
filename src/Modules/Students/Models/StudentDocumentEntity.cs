...
/// <summary>
/// Stores metadata for a document attached to a Student.
...
>>>>>>> c40f31f829a59dcdb7fd9fe0046a26e6e366eca0
	...
	/// <summary>Gets the owning Student identifier.</summary>
	...
	/// <summary>Creates document metadata for a Student.</summary>
	public static StudentDocumentEntity Create(
		Guid tenantId,
		Guid studentId,
		DocumentMetadata metadata)
	{
		...
		return new StudentDocumentEntity
		{
			TenantId = tenantId,
			StudentId = studentId,
