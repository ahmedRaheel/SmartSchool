...
public static class CreateStudentGuardian
{
    ...
    public sealed class Handler(ICreateStudentGuardianCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("StudentGuardian", "SG", request.TenantId, 3, cancellationToken);
