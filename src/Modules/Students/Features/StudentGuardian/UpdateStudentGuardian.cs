...
public static class UpdateStudentGuardian
{
	...
	internal sealed class UpdateStudentGuardianDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdateStudentGuardian
	{
		...
		: IRequestHandler<Request, Result<Response>>
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(StudentGuardianEntity), request.Code)));
			}
