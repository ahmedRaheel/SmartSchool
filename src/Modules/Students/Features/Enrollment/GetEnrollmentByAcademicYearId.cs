...
public static class GetEnrollmentByAcademicYearId
{
    ...
    public interface IGetEnrollmentByAcademicYearIdQuery
    {
    ...
    internal sealed class GetEnrollmentByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetEnrollmentByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetEnrollmentByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/students/student-enrollment/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetEnrollmentByAcademicYearId")
            .WithTags("Students")
