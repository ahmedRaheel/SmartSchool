...
public static class GetEnrollmentByStudentId
{
    ...
    public interface IGetEnrollmentByStudentIdQuery
    {
    ...
    internal sealed class GetEnrollmentByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetEnrollmentByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetEnrollmentByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/students/student-enrollment/by-student/{parentId:guid}",
            ...
            .WithName("GetEnrollmentByStudentId")
            .WithTags("Students")
