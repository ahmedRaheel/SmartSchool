...
Task<AttendanceEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateAttendanceCommand(IStudentsDbContext dbContext) : IUpdateAttendanceCommand
    {
    ...
    public sealed class Handler(IUpdateAttendanceCommand command)
