...
public static class CreateAttendance
{
    ...
    internal sealed class CreateAttendanceCommand(IStudentsDbContext dbContext) : ICreateAttendanceCommand
    {
    ...
    public sealed class Handler(ICreateAttendanceCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Attendance", "ATT", request.TenantId, 3, cancellationToken);
