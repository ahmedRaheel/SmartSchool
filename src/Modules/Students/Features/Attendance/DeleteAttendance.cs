...
public static class DeleteAttendance
{
    ...
    internal sealed class DeleteAttendanceCommand(IStudentsDbContext dbContext) : IDeleteAttendanceCommand
    {
    ...
    public sealed class Handler(IDeleteAttendanceCommand command)
