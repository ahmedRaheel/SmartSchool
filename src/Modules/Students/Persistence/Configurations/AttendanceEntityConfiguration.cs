...
/// <summary>
/// Defines relational persistence rules for <see cref="AttendanceEntity"/>.
/// </summary>
public sealed class AttendanceEntityConfiguration
	: IEntityTypeConfiguration<AttendanceEntity>
{
	public void Configure(EntityTypeBuilder<AttendanceEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("attendance_id");
	}
}
