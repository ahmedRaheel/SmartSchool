...
public static class GetRoleAssignmentById
{
	...
	public interface IGetRoleAssignmentById
	{
	...
	internal sealed class GetRoleAssignmentByIdDataAccess(
		IDbConnectionFactory connectionFactory) : IGetRoleAssignmentById
	{
	...
	public sealed class Handler(IGetRoleAssignmentById dataAccess)
