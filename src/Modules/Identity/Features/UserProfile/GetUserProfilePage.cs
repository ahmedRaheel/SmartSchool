...
public static class GetUserProfilePage
{
	...
	public interface IGetUserProfilePage
	{
	...
	internal sealed class GetUserProfilePageDataAccess(
		IDbConnectionFactory connectionFactory) : IGetUserProfilePage
	{
	...
	public sealed class Handler(IGetUserProfilePage dataAccess)
