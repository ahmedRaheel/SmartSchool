...
/// <summary>
/// Defines relational persistence rules for <see cref="ScholarshipEntity"/>.
/// </summary>
public sealed class ScholarshipEntityConfiguration
	: IEntityTypeConfiguration<ScholarshipEntity>
{
