...
/// <summary>
/// Defines relational persistence rules for <see cref="StudentFeeEntity"/>.
/// </summary>
public sealed class StudentFeeEntityConfiguration
	: IEntityTypeConfiguration<StudentFeeEntity>
{
	public void Configure(EntityTypeBuilder<StudentFeeEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("student_fee_id");
	}
}
