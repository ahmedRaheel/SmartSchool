...
/// </summary>
public sealed class FeeTypeQuery(
	IApplicationDbContext dbContext,
	IDbConnectionFactory connectionFactory) : IFeeTypeQuery
{
		...
		CancellationToken cancellationToken)
	{
		return dbContext
			...
			.SingleOrDefaultAsync(
				entity => entity.TenantId == tenantId && entity.FeeTypeId == id,
				cancellationToken);
	}
		...
		return dbContext
			...
			.AnyAsync(
				entity =>
					...
					&& (!excludingId.HasValue || (excludingId.HasValue && entity.FeeTypeId != excludingId.Value)),
				cancellationToken);
	}
}
