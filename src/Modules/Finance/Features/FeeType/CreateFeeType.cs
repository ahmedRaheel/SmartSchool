...
public static class CreateFeeType
{
	...
	public interface ICreateFeeType
	{
		Task AddAsync(
	...
	internal sealed class CreateFeeTypeDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateFeeType
	{
	...
	public sealed class Handler(ICreateFeeType dataAccess)
		: IRequestHandler<Request, Result<Response>>
	{
			...
			CancellationToken cancellationToken)
		{
			...
			var entity = FeeTypeEntity.Create(
				request.TenantId,
				request.Code,
				request.Name);
