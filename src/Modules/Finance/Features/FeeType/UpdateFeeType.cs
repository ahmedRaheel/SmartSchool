...
public static class UpdateFeeType
{
    ...
    public interface IUpdateFeeTypeCommand
    {
        Task UpdateAsync(
...
Task<FeeTypeEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateFeeTypeCommand(IFinanceDbContext dbContext) : IUpdateFeeTypeCommand
    {
    ...
    public sealed class Handler(IUpdateFeeTypeCommand command)
