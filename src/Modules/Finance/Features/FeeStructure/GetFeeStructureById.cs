...
public static class GetFeeStructureById
{
    ...
    public interface IGetFeeStructureByIdQuery
    {
    ...
    internal sealed class GetFeeStructureByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetFeeStructureByIdQuery
    {
    ...
    public sealed class Handler(IGetFeeStructureByIdQuery query)
