...
public static class UpdateStudentFee
{
    ...
    public interface IUpdateStudentFeeCommand
    {
        Task UpdateAsync(
...
Task<StudentFeeEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateStudentFeeCommand(IFinanceDbContext dbContext) : IUpdateStudentFeeCommand
    {
    ...
    public sealed class Handler(IUpdateStudentFeeCommand command)
