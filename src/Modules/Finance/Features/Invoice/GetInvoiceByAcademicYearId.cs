...
public static class GetInvoiceByAcademicYearId
{
    ...
    public interface IGetInvoiceByAcademicYearIdQuery
    {
    ...
    internal sealed class GetInvoiceByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetInvoiceByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetInvoiceByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/finance/student-invoice/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetInvoiceByAcademicYearId")
            .WithTags("Finance")
