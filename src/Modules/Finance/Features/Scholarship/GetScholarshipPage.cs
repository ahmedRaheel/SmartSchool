...
public static class GetScholarshipPage
{
    ...
    public interface IGetScholarshipPageQuery
    {
        ...
        public async Task<PagedResult<Response>> GetPageAsync(
                ...
                CancellationToken cancellationToken)
            {
                ...
                const string countSql = """
                    SELECT COUNT(*)
                    FROM finance.scholarship AS entity
                ...
                const string pageSql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.is_active = TRUE
                      AND (@BranchId IS NULL OR entity.branch_id = @BranchId)
                    ORDER BY entity.scholarship_id
    ...
    public sealed class Handler(IGetScholarshipPageQuery query)
