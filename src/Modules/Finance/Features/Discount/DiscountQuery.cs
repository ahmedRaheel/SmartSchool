...
/// </summary>
public sealed class DiscountQuery(IDbConnectionFactory connectionFactory) : IDiscountQuery
{
		...
		CancellationToken cancellationToken)
	{
		...
		return await connection.QuerySingleOrDefaultAsync<DiscountEntity>(
