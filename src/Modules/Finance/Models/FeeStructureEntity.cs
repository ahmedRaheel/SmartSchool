...
public sealed class FeeStructureEntity : Entity
{
    ...
    public static FeeStructureEntity Create(Guid tenantId, string code, Guid gradeLevelId,Guid feeTypeId,decimal amount,string frequency,Guid? academicYearId=null,DateOnly? effectiveFrom=null,DateOnly? effectiveTo=null)
    {
