...
public static class UpdateApplicant
{
	/// <summary>
	...
	internal sealed class UpdateApplicantDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdateApplicant
	{
		...
		public async Task<ApplicantEntity?> GetByIdAsync(
				...
				CancellationToken cancellationToken)
			{
				...
				return await connection.QuerySingleOrDefaultAsync<ApplicantEntity>(
					new CommandDefinition(
						sql,
						new
						{
