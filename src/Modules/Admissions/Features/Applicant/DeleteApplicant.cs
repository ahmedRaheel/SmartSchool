...
public static class DeleteApplicant
{
    ...
    internal sealed class DeleteApplicantCommand(IAdmissionsDbContext dbContext) : IDeleteApplicantCommand
    {
    ...
    public sealed class Handler(IDeleteApplicantCommand command)
