...
public static class CreateAdmissionDecision
{
    ...
    public sealed class Handler(ICreateAdmissionDecisionCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("AdmissionDecision", "AD", request.TenantId, 3, cancellationToken);
