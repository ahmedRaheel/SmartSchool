...
Task<ApplicationEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateApplicationCommand(IAdmissionsDbContext dbContext) : IUpdateApplicationCommand
    {
    ...
    public sealed class Handler(IUpdateApplicationCommand command)
