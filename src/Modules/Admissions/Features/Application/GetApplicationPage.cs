...
public static class GetApplicationPage
{
    ...
    public interface IGetApplicationPageQuery
    {
    ...
    internal sealed class GetApplicationPageQuery(
        IDbConnectionFactory connectionFactory) : IGetApplicationPageQuery
    {
    ...
    public sealed class Handler(IGetApplicationPageQuery query)
