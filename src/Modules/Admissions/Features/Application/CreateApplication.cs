...
public static class CreateApplication
{
    ...
    internal sealed class CreateApplicationCommand(IAdmissionsDbContext dbContext) : ICreateApplicationCommand
    {
    ...
    public sealed class Handler(ICreateApplicationCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Application", "APP", request.TenantId, 3, cancellationToken);
