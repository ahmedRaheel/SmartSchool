...
/// <summary>
/// Stores metadata for a document attached to a driver.
...
public sealed class DriverDocumentEntity : Entity
{
	...
	/// <summary>Gets the owning driver identifier.</summary>
	...
	/// <summary>Creates document metadata for a driver.</summary>
	public static DriverDocumentEntity Create(
		Guid tenantId,
		Guid driverId,
