...
public static class CreateRoute
{
	...
	internal sealed class CreateRouteDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateRoute
	{
	...
	public sealed class Handler(ICreateRoute dataAccess)
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(RouteEntity), request.Code)));
			}
