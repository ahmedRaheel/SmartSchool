...
public static class GetRouteByCampusId
{
    ...
    public interface IGetRouteByCampusIdQuery
    {
    ...
    internal sealed class GetRouteByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetRouteByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetRouteByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/transport/route/by-campus/{parentId:guid}",
