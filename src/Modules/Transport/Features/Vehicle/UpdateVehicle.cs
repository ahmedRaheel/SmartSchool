...
Task<VehicleEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateVehicleCommand(ITransportDbContext dbContext) : IUpdateVehicleCommand
    {
    ...
    public sealed class Handler(IUpdateVehicleCommand command)
