...
public static class GetVehicleByCampusId
{
    ...
    public interface IGetVehicleByCampusIdQuery
    {
    ...
    internal sealed class GetVehicleByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetVehicleByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetVehicleByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/transport/vehicle/by-campus/{parentId:guid}",
