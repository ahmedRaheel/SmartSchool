...
public static class GetStudentTransportPage
{
    ...
    public interface IGetStudentTransportPageQuery
    {
    ...
    internal sealed class GetStudentTransportPageQuery(
        IDbConnectionFactory connectionFactory) : IGetStudentTransportPageQuery
    {
    ...
    public sealed class Handler(IGetStudentTransportPageQuery query)
