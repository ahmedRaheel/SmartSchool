...
public static class GetStopPage
{
    ...
    public interface IGetStopPageQuery
    {
    ...
    internal sealed class GetStopPageQuery(
        IDbConnectionFactory connectionFactory) : IGetStopPageQuery
    {
    ...
    public sealed class Handler(IGetStopPageQuery query)
