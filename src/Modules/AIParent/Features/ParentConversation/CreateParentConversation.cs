...
public static class CreateParentConversation
{
	...
	internal sealed class CreateParentConversationDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateParentConversation
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(ParentConversationEntity), request.Code)));
			}
