...
public static class GetParentMessagePage
{
	...
	public interface IGetParentMessagePage
	{
	...
	internal sealed class GetParentMessagePagePersistence(
		IDbConnectionFactory connectionFactory) : IGetParentMessagePage
	{
	...
	public sealed class Handler(IGetParentMessagePage dataAccess)
