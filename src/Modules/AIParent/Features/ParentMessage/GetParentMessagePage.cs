...
public static class GetParentMessagePage
{
    ...
    public interface IGetParentMessagePageQuery
    {
    ...
    internal sealed class GetParentMessagePageQuery(
        IDbConnectionFactory connectionFactory) : IGetParentMessagePageQuery
    {
    ...
    public sealed class Handler(IGetParentMessagePageQuery query)
