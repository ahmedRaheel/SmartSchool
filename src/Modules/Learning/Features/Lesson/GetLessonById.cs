...
public static class GetLessonById
{
	...
	internal sealed class GetLessonByIdDataAccess(
		IDbConnectionFactory connectionFactory) : IGetLessonById
	{
	...
	public sealed class Handler(IGetLessonById dataAccess)
