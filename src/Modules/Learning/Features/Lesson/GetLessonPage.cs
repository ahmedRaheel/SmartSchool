...
public static class GetLessonPage
{
    ...
    public interface IGetLessonPageQuery
    {
    ...
    internal sealed class GetLessonPageQuery(
        IDbConnectionFactory connectionFactory) : IGetLessonPageQuery
    {
    ...
    public sealed class Handler(IGetLessonPageQuery query)
