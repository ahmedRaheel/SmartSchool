...
public static class GetAssignmentSubmissionByAcademicAssignmentId
{
    ...
    public interface IGetAssignmentSubmissionByAcademicAssignmentIdQuery
    {
    ...
    internal sealed class GetAssignmentSubmissionByAcademicAssignmentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAssignmentSubmissionByAcademicAssignmentIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE tenant_id = @TenantId
                      AND entity.academic_assignment_id = @ParentId
                      AND is_active = TRUE;
                    """;
    ...
    public sealed class Handler(IGetAssignmentSubmissionByAcademicAssignmentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/learning/student-assignment-submission/by-academic-assignment/{parentId:guid}",
            ...
            .WithName("GetAssignmentSubmissionByAcademicAssignmentId")
            .WithTags("Learning")
