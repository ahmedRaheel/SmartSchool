...
public static class GetAssignmentByTeachingGroupId
{
    ...
    public interface IGetAssignmentByTeachingGroupIdQuery
    {
    ...
    internal sealed class GetAssignmentByTeachingGroupIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAssignmentByTeachingGroupIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.teaching_group_id = @ParentId
    ...
    public sealed class Handler(IGetAssignmentByTeachingGroupIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/learning/academic-assignment/by-teaching-group/{parentId:guid}",
            ...
            .WithName("GetAssignmentByTeachingGroupId")
            .WithTags("Learning")
