...
public static class GetAssignmentByTeacherEmployeeId
{
    ...
    public interface IGetAssignmentByTeacherEmployeeIdQuery
    {
    ...
    internal sealed class GetAssignmentByTeacherEmployeeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAssignmentByTeacherEmployeeIdQuery
    {
    ...
    public sealed class Handler(IGetAssignmentByTeacherEmployeeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/learning/academic-assignment/by-teacher-employee/{parentId:guid}",
            ...
            .WithName("GetAssignmentByTeacherEmployeeId")
            .WithTags("Learning")
