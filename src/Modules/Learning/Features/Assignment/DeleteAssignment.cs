...
public static class DeleteAssignment
{
    ...
    internal sealed class DeleteAssignmentCommand(ILearningDbContext dbContext) : IDeleteAssignmentCommand
    {
    ...
    public sealed class Handler(IDeleteAssignmentCommand command)
