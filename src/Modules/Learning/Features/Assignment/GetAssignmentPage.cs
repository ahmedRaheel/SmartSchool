...
public static class GetAssignmentPage
{
    ...
    public interface IGetAssignmentPage
    {
    ...
    internal sealed class GetAssignmentPagePersistence(
        IDbConnectionFactory connectionFactory) : IGetAssignmentPage
    {
    ...
    public sealed class Handler(IGetAssignmentPage dataAccess)
