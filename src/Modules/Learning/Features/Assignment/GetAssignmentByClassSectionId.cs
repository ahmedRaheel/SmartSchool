...
public static class GetAssignmentByClassSectionId
{
    ...
    public interface IGetAssignmentByClassSectionIdQuery
    {
    ...
    internal sealed class GetAssignmentByClassSectionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAssignmentByClassSectionIdQuery
    {
    ...
    public sealed class Handler(IGetAssignmentByClassSectionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/learning/academic-assignment/by-class-section/{parentId:guid}",
