...
/// <summary>
/// Defines relational persistence rules for <see cref="LearningResourceEntity"/>.
/// </summary>
public sealed class LearningResourceEntityConfiguration
	: IEntityTypeConfiguration<LearningResourceEntity>
{
