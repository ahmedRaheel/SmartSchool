...
public static class GetStudentExamResultByExamSubjectId
{
    ...
    public interface IGetStudentExamResultByExamSubjectIdQuery
    {
    ...
    internal sealed class GetStudentExamResultByExamSubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentExamResultByExamSubjectIdQuery
    {
    ...
    public sealed class Handler(IGetStudentExamResultByExamSubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/student-exam-result/by-exam-subject/{parentId:guid}",
