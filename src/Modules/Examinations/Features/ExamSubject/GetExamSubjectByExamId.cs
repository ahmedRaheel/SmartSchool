...
public static class GetExamSubjectByExamId
{
    ...
    public interface IGetExamSubjectByExamIdQuery
    {
    ...
    internal sealed class GetExamSubjectByExamIdQuery(IDbConnectionFactory connectionFactory)
        : IGetExamSubjectByExamIdQuery
    {
    ...
    public sealed class Handler(IGetExamSubjectByExamIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/exam-subject/by-exam/{parentId:guid}",
            ...
            .WithName("GetExamSubjectByExamId")
