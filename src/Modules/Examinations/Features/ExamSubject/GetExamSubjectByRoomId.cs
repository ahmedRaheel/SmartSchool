...
public static class GetExamSubjectByRoomId
{
    ...
    public interface IGetExamSubjectByRoomIdQuery
    {
    ...
    internal sealed class GetExamSubjectByRoomIdQuery(IDbConnectionFactory connectionFactory)
        : IGetExamSubjectByRoomIdQuery
    {
    ...
    public sealed class Handler(IGetExamSubjectByRoomIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/exam-subject/by-room/{parentId:guid}",
