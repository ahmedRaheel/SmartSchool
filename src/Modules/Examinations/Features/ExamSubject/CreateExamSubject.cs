...
public static class CreateExamSubject
{
	...
	public interface ICreateExamSubject
	{
		Task AddAsync(
	...
	internal sealed class CreateExamSubjectPersistence(IApplicationDbContext dbContext) : ICreateExamSubject
	{
	...
	public sealed class Handler(ICreateExamSubject dataAccess)
