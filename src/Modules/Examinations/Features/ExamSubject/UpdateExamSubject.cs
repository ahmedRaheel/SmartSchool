...
public static class UpdateExamSubject
{
    ...
    public interface IUpdateExamSubjectCommand
    {
        Task UpdateAsync(
...
Task<ExamSubjectEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateExamSubjectCommand(IExaminationsDbContext dbContext) : IUpdateExamSubjectCommand
    {
        ...
        public async Task<ExamSubjectEntity?> GetByIdAsync(
                ...
                CancellationToken cancellationToken)
            {
                return await dbContext.ExamSubjects
                    .FirstOrDefaultAsync(
    ...
    public sealed class Handler(IUpdateExamSubjectCommand command)
