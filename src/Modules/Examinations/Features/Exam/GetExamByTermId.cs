...
public static class GetExamByTermId
{
    ...
    public interface IGetExamByTermIdQuery
    {
    ...
    internal sealed class GetExamByTermIdQuery(IDbConnectionFactory connectionFactory)
        : IGetExamByTermIdQuery
    {
    ...
    public sealed class Handler(IGetExamByTermIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/exam/by-term/{parentId:guid}",
