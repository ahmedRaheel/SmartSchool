...
public static class GetExamByCampusId
{
    ...
    public interface IGetExamByCampusIdQuery
    {
    ...
    internal sealed class GetExamByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetExamByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetExamByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/exam/by-campus/{parentId:guid}",
