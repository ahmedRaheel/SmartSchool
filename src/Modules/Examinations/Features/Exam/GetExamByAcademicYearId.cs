...
public static class GetExamByAcademicYearId
{
    ...
    public interface IGetExamByAcademicYearIdQuery
    {
    ...
    internal sealed class GetExamByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetExamByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetExamByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/examinations/exam/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetExamByAcademicYearId")
