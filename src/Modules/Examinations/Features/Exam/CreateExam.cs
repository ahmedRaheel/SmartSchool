...
public static class CreateExam
{
    ...
    public sealed class Handler(ICreateExamCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Exam", "EXA", request.TenantId, 3, cancellationToken);
