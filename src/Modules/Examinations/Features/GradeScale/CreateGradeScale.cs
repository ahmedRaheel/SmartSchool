...
public static class CreateGradeScale
{
    ...
    internal sealed class CreateGradeScaleCommand(IExaminationsDbContext dbContext) : ICreateGradeScaleCommand
    {
    ...
    public sealed class Handler(ICreateGradeScaleCommand command)
