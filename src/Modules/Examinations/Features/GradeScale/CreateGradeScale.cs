...
public static class CreateGradeScale
{
	...
	public interface ICreateGradeScale
	{
		Task AddAsync(
	...
	internal sealed class CreateGradeScaleDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateGradeScale
	{
	...
	public sealed class Handler(ICreateGradeScale dataAccess)
