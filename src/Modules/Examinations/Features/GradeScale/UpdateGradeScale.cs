...
public static class UpdateGradeScale
{
	...
	public interface IUpdateGradeScale
	{
		Task UpdateAsync(
...
Task<GradeScaleEntity?> GetByIdAsync(
	...
	internal sealed class UpdateGradeScalePersistence(IExaminationsDbContext dbContext) : IUpdateGradeScale
	{
	...
	public sealed class Handler(IUpdateGradeScale dataAccess)
