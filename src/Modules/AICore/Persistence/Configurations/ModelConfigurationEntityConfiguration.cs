...
/// <summary>
/// Defines relational persistence rules for <see cref="ModelConfigurationEntity"/>.
/// </summary>
public sealed class ModelConfigurationEntityConfiguration
	: IEntityTypeConfiguration<ModelConfigurationEntity>
{
	public void Configure(EntityTypeBuilder<ModelConfigurationEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("model_configuration_id");
