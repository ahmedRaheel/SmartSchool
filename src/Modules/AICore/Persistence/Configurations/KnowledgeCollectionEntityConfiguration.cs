...
/// <summary>
/// Defines relational persistence rules for <see cref="KnowledgeCollectionEntity"/>.
/// </summary>
public sealed class KnowledgeCollectionEntityConfiguration
	: IEntityTypeConfiguration<KnowledgeCollectionEntity>
{
	public void Configure(EntityTypeBuilder<KnowledgeCollectionEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("knowledge_collection_id");
