...
public static class GetAiExecutionLogPage
{
    ...
    public interface IGetAiExecutionLogPageQuery
    {
    ...
    internal sealed class GetAiExecutionLogPageQuery(
        IDbConnectionFactory connectionFactory) : IGetAiExecutionLogPageQuery
    {
    ...
    public sealed class Handler(IGetAiExecutionLogPageQuery query)
