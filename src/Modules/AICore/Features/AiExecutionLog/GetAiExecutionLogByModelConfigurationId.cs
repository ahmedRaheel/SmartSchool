...
public static class GetAiExecutionLogByModelConfigurationId
{
    ...
    public interface IGetAiExecutionLogByModelConfigurationIdQuery
    {
    ...
    internal sealed class GetAiExecutionLogByModelConfigurationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAiExecutionLogByModelConfigurationIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.model_configuration_id = @ParentId
    ...
    public sealed class Handler(IGetAiExecutionLogByModelConfigurationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aicore/ai-execution-log/by-model-configuration/{parentId:guid}",
            ...
            .WithName("GetAiExecutionLogByModelConfigurationId")
            .WithTags("AICore")
