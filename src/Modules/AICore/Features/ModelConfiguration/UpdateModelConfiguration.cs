...
public static class UpdateModelConfiguration
{
    ...
    public interface IUpdateModelConfigurationCommand
    {
        Task UpdateAsync(
...
Task<ModelConfigurationEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateModelConfigurationCommand(IAICoreDbContext dbContext) : IUpdateModelConfigurationCommand
    {
    ...
    public sealed class Handler(IUpdateModelConfigurationCommand command)
