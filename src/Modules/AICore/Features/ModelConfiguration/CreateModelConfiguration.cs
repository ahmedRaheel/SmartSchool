...
public static class CreateModelConfiguration
{
	...
	internal sealed class CreateModelConfigurationDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateModelConfiguration
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(ModelConfigurationEntity), request.Code)));
			}
