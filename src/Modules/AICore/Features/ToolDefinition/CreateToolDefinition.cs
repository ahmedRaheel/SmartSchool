...
public static class CreateToolDefinition
{
	...
	internal sealed class CreateToolDefinitionDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateToolDefinition
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(ToolDefinitionEntity), request.Code)));
			}
