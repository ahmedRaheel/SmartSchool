...
public static class UpdateToolDefinition
{
	...
	public interface IUpdateToolDefinition
	{
		Task UpdateAsync(
...
Task<ToolDefinitionEntity?> GetByIdAsync(
	...
	internal sealed class UpdateToolDefinitionPersistence(IApplicationDbContext dbContext) : IUpdateToolDefinition
	{
	...
	public sealed class Handler(IUpdateToolDefinition dataAccess)
