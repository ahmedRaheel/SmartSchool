...
public static class UpdateToolDefinition
{
    ...
    public interface IUpdateToolDefinitionCommand
    {
        Task UpdateAsync(
...
Task<ToolDefinitionEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateToolDefinitionCommand(IAICoreDbContext dbContext) : IUpdateToolDefinitionCommand
    {
    ...
    public sealed class Handler(IUpdateToolDefinitionCommand command)
