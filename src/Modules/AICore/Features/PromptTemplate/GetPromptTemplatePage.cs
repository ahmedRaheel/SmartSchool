...
public static class GetPromptTemplatePage
{
    ...
    public interface IGetPromptTemplatePageQuery
    {
    ...
    internal sealed class GetPromptTemplatePageQuery(
        IDbConnectionFactory connectionFactory) : IGetPromptTemplatePageQuery
    {
    ...
    public sealed class Handler(IGetPromptTemplatePageQuery query)
