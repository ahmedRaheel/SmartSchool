...
public static class GetPromptTemplatePage
{
	...
	public interface IGetPromptTemplatePage
	{
	...
	internal sealed class GetPromptTemplatePageDataAccess(
	...
	public sealed class Handler(IGetPromptTemplatePage dataAccess)
