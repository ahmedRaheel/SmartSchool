...
public static class GetKnowledgeChunkPage
{
    ...
    public interface IGetKnowledgeChunkPageQuery
    {
    ...
    internal sealed class GetKnowledgeChunkPageQuery(
        IDbConnectionFactory connectionFactory) : IGetKnowledgeChunkPageQuery
    {
    ...
    public sealed class Handler(IGetKnowledgeChunkPageQuery query)
