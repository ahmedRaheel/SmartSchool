...
public static class GetKnowledgeChunkPage
{
	...
	public interface IGetKnowledgeChunkPage
	{
	...
	internal sealed class GetKnowledgeChunkPageDataAccess(
	...
	public sealed class Handler(IGetKnowledgeChunkPage dataAccess)
