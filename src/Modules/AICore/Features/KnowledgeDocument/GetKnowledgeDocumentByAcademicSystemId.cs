...
public static class GetKnowledgeDocumentByAcademicSystemId
{
    ...
    public interface IGetKnowledgeDocumentByAcademicSystemIdQuery
    {
    ...
    internal sealed class GetKnowledgeDocumentByAcademicSystemIdQuery(IDbConnectionFactory connectionFactory)
        : IGetKnowledgeDocumentByAcademicSystemIdQuery
    {
    ...
    public sealed class Handler(IGetKnowledgeDocumentByAcademicSystemIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aicore/knowledge-document/by-academic-system/{parentId:guid}",
            ...
            .WithName("GetKnowledgeDocumentByAcademicSystemId")
            .WithTags("AICore")
