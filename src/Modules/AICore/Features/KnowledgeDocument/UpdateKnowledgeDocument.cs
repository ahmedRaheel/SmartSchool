...
public static class UpdateKnowledgeDocument
{
    ...
    public interface IUpdateKnowledgeDocumentCommand
    {
        Task UpdateAsync(
...
Task<KnowledgeDocumentEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateKnowledgeDocumentCommand(IAICoreDbContext dbContext) : IUpdateKnowledgeDocumentCommand
    {
    ...
    public sealed class Handler(IUpdateKnowledgeDocumentCommand command)
