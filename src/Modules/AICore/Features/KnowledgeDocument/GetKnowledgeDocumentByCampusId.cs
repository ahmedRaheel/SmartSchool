...
public static class GetKnowledgeDocumentByCampusId
{
    ...
    public interface IGetKnowledgeDocumentByCampusIdQuery
    {
    ...
    internal sealed class GetKnowledgeDocumentByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetKnowledgeDocumentByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetKnowledgeDocumentByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aicore/knowledge-document/by-campus/{parentId:guid}",
            ...
            .WithName("GetKnowledgeDocumentByCampusId")
            .WithTags("AICore")
