...
/// <summary>
/// Represents the KnowledgeCollectionEntity domain entity.
/// </summary>
public sealed class KnowledgeCollectionEntity : Entity
{
	/// <summary>Gets the persisted entity identifier.</summary>
	public Guid KnowledgeCollectionId
	{
		get => Id;
	...
	/// <summary>Creates a new KnowledgeCollectionEntity.</summary>
	/// <param name="tenantId">The owning tenant identifier.</param>
	/// <param name="code">The business code.</param>
	/// <param name="name">The display name.</param>
	/// <param name="metadataJson">Optional domain metadata.</param>
	/// <returns>The newly created entity.</returns>
	public static KnowledgeCollectionEntity Create(
		Guid tenantId,
		string code,
		string name,
		string? metadataJson = null)
	{
		...
		return new KnowledgeCollectionEntity
		{
			TenantId = tenantId,
			Code = code.Trim(),
			Name = name.Trim(),
