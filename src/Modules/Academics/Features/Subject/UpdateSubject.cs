...
public static class UpdateSubject
{
	...
	internal sealed class UpdateSubjectDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdateSubject
	{
	...
	public sealed class Handler(IUpdateSubject dataAccess)
