...
public static class GetSubjectPage
{
	...
	public interface IGetSubjectPage
	{
	...
	internal sealed class GetSubjectPageDataAccess(
		IDbConnectionFactory connectionFactory) : IGetSubjectPage
	{
	...
	public sealed class Handler(IGetSubjectPage dataAccess)
	...
	private static Response MapResponse(SubjectEntity entity)
	{
		return new Response(
			entity.TenantId,
			entity.SubjectId,
