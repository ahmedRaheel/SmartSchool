...
public static class CreateAcademicSystem
{
	...
	internal sealed class CreateAcademicSystemDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateAcademicSystem
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(AcademicSystemEntity), request.Code)));
			}
