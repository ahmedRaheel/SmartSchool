...
public static class GetAcademicSystemPage
{
	...
	public interface IGetAcademicSystemPage
	{
	...
	internal sealed class GetAcademicSystemPageDataAccess(
	...
	public sealed class Handler(IGetAcademicSystemPage dataAccess)
