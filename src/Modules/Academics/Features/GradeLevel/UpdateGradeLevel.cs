...
public static class UpdateGradeLevel
{
	/// <summary>
	...
	public interface IUpdateGradeLevel
	{
		Task UpdateAsync(
	...
	internal sealed class UpdateGradeLevelDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdateGradeLevel
	{
	...
	public sealed class Handler(IUpdateGradeLevel dataAccess)
		: IRequestHandler<Request, Result<Response>>
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(GradeLevelEntity), request.Code)));
			}
