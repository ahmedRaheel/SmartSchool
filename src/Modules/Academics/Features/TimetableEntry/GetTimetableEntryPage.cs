...
public static class GetTimetableEntryPage
{
	...
	public interface IGetTimetableEntryPage
	{
	...
	internal sealed class GetTimetableEntryPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetTimetableEntryPage
	{
	...
	public sealed class Handler(IGetTimetableEntryPage dataAccess)
