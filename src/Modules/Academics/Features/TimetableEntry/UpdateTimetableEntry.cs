...
public static class UpdateTimetableEntry
{
	...
	public interface IUpdateTimetableEntry
	{
		Task UpdateAsync(
...
Task<TimetableEntryEntity?> GetByIdAsync(
	...
	internal sealed class UpdateTimetableEntryPersistence(IApplicationDbContext dbContext) : IUpdateTimetableEntry
	{
	...
	public sealed class Handler(IUpdateTimetableEntry dataAccess)
