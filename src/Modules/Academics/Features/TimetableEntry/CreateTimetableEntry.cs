...
public static class CreateTimetableEntry
{
	...
	public interface ICreateTimetableEntry
	{
		Task AddAsync(
	...
	internal sealed class CreateTimetableEntryPersistence(IApplicationDbContext dbContext) : ICreateTimetableEntry
	{
	...
	public sealed class Handler(ICreateTimetableEntry dataAccess)
