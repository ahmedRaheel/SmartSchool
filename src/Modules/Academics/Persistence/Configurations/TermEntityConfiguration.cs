...
/// <summary>
/// Defines relational persistence rules for <see cref="TermEntity"/>.
/// </summary>
public sealed class TermEntityConfiguration
	: IEntityTypeConfiguration<TermEntity>
{
	public void Configure(EntityTypeBuilder<TermEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("term_id");
