...
/// <summary>
/// Defines relational persistence rules for <see cref="CourseOfferingEntity"/>.
/// </summary>
public sealed class CourseOfferingEntityConfiguration
	: IEntityTypeConfiguration<CourseOfferingEntity>
{
	public void Configure(EntityTypeBuilder<CourseOfferingEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("course_offering_id");
