...
/// <summary>
/// Defines relational persistence rules for <see cref="TimetableEntity"/>.
/// </summary>
public sealed class TimetableEntityConfiguration
	: IEntityTypeConfiguration<TimetableEntity>
{
	public void Configure(EntityTypeBuilder<TimetableEntity> builder)
	{
		...
		builder.Property(entity => entity.Id).HasColumnName("timetable_id");
