...
public static class DeleteLookup
{
    ...
    public interface IDeleteLookupCommand { Task<LookupValueEntity?> GetByIdAsync(long id, CancellationToken cancellationToken); Task DeleteAsync(LookupValueEntity entity, CancellationToken cancellationToken); }
    internal sealed class DeleteLookupCommand(IReferenceDbContext dbContext) : IDeleteLookupCommand
    {
    ...
    public sealed class Handler(IDeleteLookupCommand persistence) : IRequestHandler<Command, Result<Response>>
    {
