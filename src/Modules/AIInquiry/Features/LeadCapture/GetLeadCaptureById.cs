...
public static class GetLeadCaptureById
{
    ...
    public interface IGetLeadCaptureByIdQuery
    {
    ...
    internal sealed class GetLeadCaptureByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetLeadCaptureByIdQuery
    {
    ...
    public sealed class Handler(IGetLeadCaptureByIdQuery query)
