...
public static class DeleteLeadCapture
{
    ...
    public interface IDeleteLeadCaptureCommand
    {
        Task DeleteAsync(
    ...
    internal sealed class DeleteLeadCaptureCommand(IAIInquiryDbContext dbContext) : IDeleteLeadCaptureCommand
    {
    ...
    public sealed class Handler(IDeleteLeadCaptureCommand command)
