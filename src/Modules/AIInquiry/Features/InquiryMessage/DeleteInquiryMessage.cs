...
public static class DeleteInquiryMessage
{
    ...
    public interface IDeleteInquiryMessageCommand
    {
        Task DeleteAsync(
    ...
    internal sealed class DeleteInquiryMessageCommand(IAIInquiryDbContext dbContext) : IDeleteInquiryMessageCommand
    {
    ...
    public sealed class Handler(IDeleteInquiryMessageCommand command)
