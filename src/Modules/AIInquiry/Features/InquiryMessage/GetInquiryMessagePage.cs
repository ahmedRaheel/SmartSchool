...
public static class GetInquiryMessagePage
{
    ...
    public interface IGetInquiryMessagePageQuery
    {
    ...
    internal sealed class GetInquiryMessagePageQuery(
        IDbConnectionFactory connectionFactory) : IGetInquiryMessagePageQuery
    {
    ...
    public sealed class Handler(IGetInquiryMessagePageQuery query)
