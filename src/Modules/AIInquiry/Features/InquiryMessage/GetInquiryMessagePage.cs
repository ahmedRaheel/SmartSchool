...
public static class GetInquiryMessagePage
{
	...
	public interface IGetInquiryMessagePage
	{
	...
	internal sealed class GetInquiryMessagePageDataAccess(
	...
	public sealed class Handler(IGetInquiryMessagePage dataAccess)
