...
public static class CreateInquiryMessage
{
    ...
    public interface ICreateInquiryMessageCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreateInquiryMessageCommand(IAIInquiryDbContext dbContext) : ICreateInquiryMessageCommand
    {
    ...
    public sealed class Handler(ICreateInquiryMessageCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("InquiryMessage", "IM", request.TenantId, 3, cancellationToken);
