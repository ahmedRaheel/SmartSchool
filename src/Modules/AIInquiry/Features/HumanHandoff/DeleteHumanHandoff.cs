...
public static class DeleteHumanHandoff
{
	...
	public interface IDeleteHumanHandoff
	{
		Task DeleteAsync(
	...
	internal sealed class DeleteHumanHandoffDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IDeleteHumanHandoff
	{
	...
	public sealed class Handler(IDeleteHumanHandoff dataAccess)
