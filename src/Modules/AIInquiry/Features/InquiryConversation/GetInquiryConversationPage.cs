...
public static class GetInquiryConversationPage
{
    ...
    public interface IGetInquiryConversationPageQuery
    {
    ...
    internal sealed class GetInquiryConversationPageQuery(
        IDbConnectionFactory connectionFactory) : IGetInquiryConversationPageQuery
    {
    ...
    public sealed class Handler(IGetInquiryConversationPageQuery query)
