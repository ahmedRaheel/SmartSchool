...
/// <summary>
/// Defines relational persistence rules for <see cref="InquiryMessageEntity"/>.
/// </summary>
public sealed class InquiryMessageEntityConfiguration
	: IEntityTypeConfiguration<InquiryMessageEntity>
{
	public void Configure(EntityTypeBuilder<InquiryMessageEntity> builder)
	{
		...
		builder.Property(entity => entity.InquiryMessageId).HasColumnName("inquiry_message_id");
