...
public static class GetAwardByGeneratedDocumentId
{
    ...
    public interface IGetAwardByGeneratedDocumentIdQuery
    {
    ...
    internal sealed class GetAwardByGeneratedDocumentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetAwardByGeneratedDocumentIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.generated_document_id = @ParentId
    ...
    public sealed class Handler(IGetAwardByGeneratedDocumentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/activities/student-award/by-generated-document/{parentId:guid}",
            ...
            .WithName("GetAwardByGeneratedDocumentId")
            .WithTags("Activities")
