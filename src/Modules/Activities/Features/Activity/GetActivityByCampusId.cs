...
public static class GetActivityByCampusId
{
    ...
    public interface IGetActivityByCampusIdQuery
    {
    ...
    internal sealed class GetActivityByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetActivityByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetActivityByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/activities/activity/by-campus/{parentId:guid}",
            ...
            .WithName("GetActivityByCampusId")
            .WithTags("Activities")
