...
public static class GetStudentOfMonthPage
{
	/// <summary>
	...
	public interface IGetStudentOfMonthPage
	{
	...
	internal sealed class GetStudentOfMonthPageDataAccess(
	...
	public sealed class Handler(IGetStudentOfMonthPage dataAccess)
