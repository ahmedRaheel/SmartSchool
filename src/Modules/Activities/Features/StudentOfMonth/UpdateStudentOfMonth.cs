...
public static class UpdateStudentOfMonth
{
	...
	public interface IUpdateStudentOfMonth
	{
		Task UpdateAsync(
	...
	internal sealed class UpdateStudentOfMonthDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdateStudentOfMonth
	{
	...
	public sealed class Handler(IUpdateStudentOfMonth dataAccess)
