...
public static class GetStudentActivityByStudentId
{
    ...
    public interface IGetStudentActivityByStudentIdQuery
    {
    ...
    internal sealed class GetStudentActivityByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentActivityByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetStudentActivityByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/activities/student-activity/by-student/{parentId:guid}",
            ...
            .WithName("GetStudentActivityByStudentId")
            .WithTags("Activities")
