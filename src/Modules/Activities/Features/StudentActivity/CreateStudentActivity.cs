...
public static class CreateStudentActivity
{
    ...
    public interface ICreateStudentActivityCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreateStudentActivityCommand(IActivitiesDbContext dbContext) : ICreateStudentActivityCommand
    {
        public async Task AddAsync(
                StudentActivityEntity entity,
                CancellationToken cancellationToken)
            {
                await dbContext.StudentActivities
    ...
    public sealed class Handler(ICreateStudentActivityCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("StudentActivity", "SA", request.TenantId, 3, cancellationToken);
