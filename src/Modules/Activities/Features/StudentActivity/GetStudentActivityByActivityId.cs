...
public static class GetStudentActivityByActivityId
{
    ...
    public interface IGetStudentActivityByActivityIdQuery
    {
    ...
    internal sealed class GetStudentActivityByActivityIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentActivityByActivityIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE tenant_id = @TenantId
                      AND entity.activity_id = @ParentId
                      AND is_active = TRUE;
                    """;
    ...
    public sealed class Handler(IGetStudentActivityByActivityIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/activities/student-activity/by-activity/{parentId:guid}",
            ...
            .WithName("GetStudentActivityByActivityId")
            .WithTags("Activities")
