...
/// <summary>
/// Represents the StudentOfMonthEntity domain entity.
/// </summary>
public sealed class StudentOfMonthEntity : Entity
{
	/// <summary>Gets the entity-specific identifier.</summary>
	public Guid StudentOfMonthId { get; private set; } = Guid.NewGuid();
	...
	/// <summary>Creates a new StudentOfMonthEntity.</summary>
