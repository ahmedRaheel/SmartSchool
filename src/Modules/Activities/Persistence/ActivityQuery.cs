...
public sealed class ActivityQuery(
	...
	IDbConnectionFactory connectionFactory) : IActivityQuery
{
		...
		CancellationToken cancellationToken)
	{
		return dbContext
			...
			.SingleOrDefaultAsync(
				entity => entity.TenantId == tenantId && entity.ActivityId == id,
				cancellationToken);
	}
		...
		return dbContext
			...
			.AnyAsync(
				entity =>
					...
					&& (!excludingId.HasValue || (excludingId.HasValue && entity.ActivityId != excludingId.Value)),
				cancellationToken);
	}
}
