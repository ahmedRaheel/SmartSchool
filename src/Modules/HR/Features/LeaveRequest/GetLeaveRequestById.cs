...
public static class GetLeaveRequestById
{
    ...
    public interface IGetLeaveRequestByIdQuery
    {
    ...
    internal sealed class GetLeaveRequestByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetLeaveRequestByIdQuery
    {
    ...
    public sealed class Handler(IGetLeaveRequestByIdQuery query)
