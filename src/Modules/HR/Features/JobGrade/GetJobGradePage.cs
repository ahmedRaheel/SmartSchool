...
public static class GetJobGradePage
{
    ...
    public interface IGetJobGradePageQuery
    {
    ...
    internal sealed class GetJobGradePageQuery(
        IDbConnectionFactory connectionFactory) : IGetJobGradePageQuery
    {
    ...
    public sealed class Handler(IGetJobGradePageQuery query)
