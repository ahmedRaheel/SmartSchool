...
public static class DeletePosition
{
	...
	internal sealed class DeletePositionDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IDeletePosition
	{
	...
	public sealed class Handler(IDeletePosition dataAccess)
