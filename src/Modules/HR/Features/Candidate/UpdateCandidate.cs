...
public static class UpdateCandidate
{
    ...
    public interface IUpdateCandidateCommand
    {
        Task UpdateAsync(
...
Task<CandidateEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateCandidateCommand(IHRDbContext dbContext) : IUpdateCandidateCommand
    {
    ...
    public sealed class Handler(IUpdateCandidateCommand command)
