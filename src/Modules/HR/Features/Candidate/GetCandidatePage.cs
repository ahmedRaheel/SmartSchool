...
public static class GetCandidatePage
{
    ...
    public interface IGetCandidatePageQuery
    {
    ...
    internal sealed class GetCandidatePageQuery(
        IDbConnectionFactory connectionFactory) : IGetCandidatePageQuery
    {
    ...
    public sealed class Handler(IGetCandidatePageQuery query)
