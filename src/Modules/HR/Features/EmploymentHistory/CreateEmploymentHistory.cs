...
public static class CreateEmploymentHistory
{
	...
	internal sealed class CreateEmploymentHistoryDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateEmploymentHistory
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(EmploymentHistoryEntity), request.Code)));
			}
