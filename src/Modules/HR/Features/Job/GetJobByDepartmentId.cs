...
public static class GetJobByDepartmentId
{
    ...
    public interface IGetJobByDepartmentIdQuery
    {
    ...
    internal sealed class GetJobByDepartmentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetJobByDepartmentIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.department_id = @ParentId
    ...
    public sealed class Handler(IGetJobByDepartmentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/hr/job/by-department/{parentId:guid}",
