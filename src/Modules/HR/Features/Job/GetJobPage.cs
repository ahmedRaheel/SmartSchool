...
public static class GetJobPage
{
    ...
    public interface IGetJobPageQuery
    {
    ...
    internal sealed class GetJobPageQuery(
        IDbConnectionFactory connectionFactory) : IGetJobPageQuery
    {
    ...
    public sealed class Handler(IGetJobPageQuery query)
