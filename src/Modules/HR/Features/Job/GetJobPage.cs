...
public static class GetJobPage
{
	...
	internal sealed class GetJobPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetJobPage
	{
	...
	public sealed class Handler(IGetJobPage dataAccess)
