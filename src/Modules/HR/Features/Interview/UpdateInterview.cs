...
public static class UpdateInterview
{
    ...
    public interface IUpdateInterviewCommand
    {
        Task UpdateAsync(
...
Task<InterviewEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateInterviewCommand(IHRDbContext dbContext) : IUpdateInterviewCommand
    {
    ...
    public sealed class Handler(IUpdateInterviewCommand command)
