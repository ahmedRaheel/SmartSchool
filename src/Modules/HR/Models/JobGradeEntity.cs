...
/// <summary>
/// Represents the JobGradeEntity domain entity.
/// </summary>
public sealed class JobGradeEntity : Entity
{
<<<<<<< HEAD
	/// <summary>Gets the entity-specific identifier.</summary>
	public Guid JobGradeId { get; private set; } = Guid.NewGuid();
=======
	/// <summary>Gets the persisted entity identifier.</summary>
	public Guid JobGradeId
	{
		get => Id;
...
>>>>>>> c40f31f829a59dcdb7fd9fe0046a26e6e366eca0
	...
	/// <summary>Creates a new JobGradeEntity.</summary>
	/// <param name="tenantId">The owning tenant identifier.</param>
	/// <param name="code">The business code.</param>
	/// <param name="name">The display name.</param>
	/// <param name="metadataJson">Optional domain metadata.</param>
	/// <returns>The newly created entity.</returns>
	public static JobGradeEntity Create(
		Guid tenantId,
		string code,
		string name,
