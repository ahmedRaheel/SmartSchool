...
/// <summary>
/// Stores metadata for a document attached to a candidate.
...
public sealed class CandidateDocumentEntity : Entity
{
	...
	/// <summary>Gets the owning candidate identifier.</summary>
	...
	/// <summary>Creates document metadata for a candidate.</summary>
	public static CandidateDocumentEntity Create(
		Guid tenantId,
		Guid candidateId,
		DocumentMetadata metadata)
	{
		...
		return new CandidateDocumentEntity
		{
			TenantId = tenantId,
