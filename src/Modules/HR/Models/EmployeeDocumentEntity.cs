...
/// <summary>
/// Stores metadata for a document attached to a employee.
...
<<<<<<< HEAD
	...
	public Guid EmployeeDocumentId { get; private set; } = Guid.NewGuid();
...
>>>>>>> c40f31f829a59dcdb7fd9fe0046a26e6e366eca0
	...
	/// <summary>Gets the owning employee identifier.</summary>
	...
	/// <summary>Creates document metadata for a employee.</summary>
	public static EmployeeDocumentEntity Create(
		Guid tenantId,
		Guid employeeId,
		DocumentMetadata metadata)
	{
		...
		return new EmployeeDocumentEntity
		{
			TenantId = tenantId,
