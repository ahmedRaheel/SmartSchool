...
/// <summary>
/// Configures the TeacherDocument relational table.
/// </summary>
public sealed class TeacherDocumentEntityConfiguration
	: IEntityTypeConfiguration<TeacherDocumentEntity>
{
	public void Configure(EntityTypeBuilder<TeacherDocumentEntity> builder)
	{
		builder.ToTable("TeacherDocument", SmartSchool.Modules.HR.ModuleConstants.Schema);
