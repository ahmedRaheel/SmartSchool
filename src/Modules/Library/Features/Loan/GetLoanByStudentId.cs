...
public static class GetLoanByStudentId
{
    ...
    public interface IGetLoanByStudentIdQuery
    {
    ...
    internal sealed class GetLoanByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetLoanByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetLoanByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/library/book-loan/by-student/{parentId:guid}",
