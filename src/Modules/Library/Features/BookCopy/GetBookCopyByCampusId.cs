...
public static class GetBookCopyByCampusId
{
    ...
    public interface IGetBookCopyByCampusIdQuery
    {
    ...
    internal sealed class GetBookCopyByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetBookCopyByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetBookCopyByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/library/book-copy/by-campus/{parentId:guid}",
            ...
            .WithName("GetBookCopyByCampusId")
            .WithTags("Library")
