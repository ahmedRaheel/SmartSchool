...
public static class GetBookCopyPage
{
    ...
    public interface IGetBookCopyPageQuery
    {
    ...
    internal sealed class GetBookCopyPageQuery(
        IDbConnectionFactory connectionFactory) : IGetBookCopyPageQuery
    {
    ...
    public sealed class Handler(IGetBookCopyPageQuery query)
