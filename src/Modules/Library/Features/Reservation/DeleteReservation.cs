...
public static class DeleteReservation
{
    ...
    internal sealed class DeleteReservationCommand(ILibraryDbContext dbContext) : IDeleteReservationCommand
    {
    ...
    public sealed class Handler(IDeleteReservationCommand command)
