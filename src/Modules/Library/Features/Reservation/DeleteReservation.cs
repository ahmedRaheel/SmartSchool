...
public static class DeleteReservation
{
	...
	internal sealed class DeleteReservationDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IDeleteReservation
	{
	...
	public sealed class Handler(IDeleteReservation dataAccess)
