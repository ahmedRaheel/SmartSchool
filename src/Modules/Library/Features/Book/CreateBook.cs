...
public static class CreateBook
{
    ...
    public sealed class Handler(ICreateBookCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Book", "BOO", request.TenantId, 3, cancellationToken);
