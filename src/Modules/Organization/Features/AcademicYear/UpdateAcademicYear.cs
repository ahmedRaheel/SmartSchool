...
public static class UpdateAcademicYear
{
    ...
    public interface IUpdateAcademicYearCommand
    {
        Task UpdateAsync(
...
Task<AcademicYearEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateAcademicYearCommand(IOrganizationDbContext dbContext) : IUpdateAcademicYearCommand
    {
    ...
    public sealed class Handler(IUpdateAcademicYearCommand command)
