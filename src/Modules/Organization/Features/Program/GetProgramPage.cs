...
public static class GetProgramPage
{
    ...
    public interface IGetProgramPageQuery
    {
    ...
    internal sealed class GetProgramPageQuery(
        IDbConnectionFactory connectionFactory) : IGetProgramPageQuery
    {
    ...
    public sealed class Handler(IGetProgramPageQuery query)
