...
public static class CreateProgram
{
    ...
    public sealed class Handler(ICreateProgramCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Program", "PRO", request.TenantId, 3, cancellationToken);
    ...
    {
        endpoints.MapPost(
                ApiRoutes.EntityCollection("academics", "program"),
