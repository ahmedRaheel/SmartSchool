...
public static class GetCourseOfferingByTermId
{
    ...
    public interface IGetCourseOfferingByTermIdQuery
    {
    ...
    internal sealed class GetCourseOfferingByTermIdQuery(IDbConnectionFactory connectionFactory)
        : IGetCourseOfferingByTermIdQuery
    {
    ...
    public sealed class Handler(IGetCourseOfferingByTermIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/course-offering/by-term/{parentId:guid}",
            ...
            .WithName("GetCourseOfferingByTermId")
