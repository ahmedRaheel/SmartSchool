...
public static class GetCourseOfferingByCampusId
{
    ...
    public interface IGetCourseOfferingByCampusIdQuery
    {
    ...
    internal sealed class GetCourseOfferingByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetCourseOfferingByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetCourseOfferingByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/course-offering/by-campus/{parentId:guid}",
            ...
            .WithName("GetCourseOfferingByCampusId")
