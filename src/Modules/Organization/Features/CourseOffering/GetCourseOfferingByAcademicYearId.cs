...
public static class GetCourseOfferingByAcademicYearId
{
    ...
    public interface IGetCourseOfferingByAcademicYearIdQuery
    {
    ...
    internal sealed class GetCourseOfferingByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetCourseOfferingByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetCourseOfferingByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/course-offering/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetCourseOfferingByAcademicYearId")
