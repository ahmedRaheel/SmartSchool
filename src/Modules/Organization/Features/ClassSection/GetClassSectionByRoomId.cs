...
public static class GetClassSectionByRoomId
{
    ...
    public interface IGetClassSectionByRoomIdQuery
    {
    ...
    internal sealed class GetClassSectionByRoomIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassSectionByRoomIdQuery
    {
    ...
    public sealed class Handler(IGetClassSectionByRoomIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/class-section/by-room/{parentId:guid}",
            ...
            .WithName("GetClassSectionByRoomId")
