...
public static class GetClassSectionByClassTeacherEmployeeId
{
    ...
    public interface IGetClassSectionByClassTeacherEmployeeIdQuery
    {
    ...
    internal sealed class GetClassSectionByClassTeacherEmployeeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassSectionByClassTeacherEmployeeIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    SELECT
                        ...
                        entity.room_id AS "RoomId",
                        p3.code AS "RoomCode",
                        p3.name AS "RoomName",
                        entity.grade_level_id AS "GradeLevelId",
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.class_teacher_employee_id = @ParentId
    ...
    public sealed class Handler(IGetClassSectionByClassTeacherEmployeeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/class-section/by-class-teacher-employee/{parentId:guid}",
            ...
            .WithName("GetClassSectionByClassTeacherEmployeeId")
