...
public static class GetClassSectionByCampusId
{
    ...
    public interface IGetClassSectionByCampusIdQuery
    {
    ...
    internal sealed class GetClassSectionByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassSectionByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetClassSectionByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/class-section/by-campus/{parentId:guid}",
            ...
            .WithName("GetClassSectionByCampusId")
