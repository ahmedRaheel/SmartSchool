...
public static class GetClassSectionBySectionId
{
    ...
    public interface IGetClassSectionBySectionIdQuery
    {
    ...
    internal sealed class GetClassSectionBySectionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassSectionBySectionIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.section_id = @ParentId
    ...
    public sealed class Handler(IGetClassSectionBySectionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/class-section/by-section/{parentId:guid}",
            ...
            .WithName("GetClassSectionBySectionId")
