...
public static class GetClassSectionByProgramGradeId
{
    ...
    public interface IGetClassSectionByProgramGradeIdQuery
    {
    ...
    internal sealed class GetClassSectionByProgramGradeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassSectionByProgramGradeIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.program_grade_id = @ParentId
    ...
    public sealed class Handler(IGetClassSectionByProgramGradeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/class-section/by-program-grade/{parentId:guid}",
            ...
            .WithName("GetClassSectionByProgramGradeId")
