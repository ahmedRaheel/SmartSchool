...
public static class UpdateGradeLevel
{
    ...
    public interface IUpdateGradeLevelCommand
    {
        Task UpdateAsync(
...
Task<GradeLevelEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateGradeLevelCommand(IOrganizationDbContext dbContext) : IUpdateGradeLevelCommand
    {
    ...
    public sealed class Handler(IUpdateGradeLevelCommand command)
