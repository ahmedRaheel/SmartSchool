...
public static class GetGradeLevelPage
{
	...
	public interface IGetGradeLevelPage
	{
	...
	internal sealed class GetGradeLevelPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetGradeLevelPage
	{
	...
	public sealed class Handler(IGetGradeLevelPage dataAccess)
