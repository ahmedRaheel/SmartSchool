...
public static class GetGradeLevelPage
{
    ...
    public interface IGetGradeLevelPageQuery
    {
    ...
    internal sealed class GetGradeLevelPageQuery(
        IDbConnectionFactory connectionFactory) : IGetGradeLevelPageQuery
    {
        public async Task<PagedResult<Response>> GetPageAsync(
                ...
                CancellationToken cancellationToken)
            {
                ...
                const string pageSql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.is_active = TRUE
                    ORDER BY entity.grade_level_id
    ...
    public sealed class Handler(IGetGradeLevelPageQuery query)
    ...
    {
        endpoints.MapGet(
                ApiRoutes.EntityCollection("academics", "grade-level"),
