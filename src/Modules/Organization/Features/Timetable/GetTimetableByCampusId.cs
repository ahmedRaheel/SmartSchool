...
public static class GetTimetableByCampusId
{
    ...
    public interface IGetTimetableByCampusIdQuery
    {
    ...
    internal sealed class GetTimetableByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTimetableByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetTimetableByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/timetable/by-campus/{parentId:guid}",
            ...
            .WithName("GetTimetableByCampusId")
