...
namespace SmartSchool.Modules.Organization.Features.Timetable;

public static class GetTimetableByAcademicYearId
{
    ...
    public interface IGetTimetableByAcademicYearIdQuery
    {
    ...
    internal sealed class GetTimetableByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTimetableByAcademicYearIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    SELECT
                        ...
                        p3.code AS "TermCode",
                        p3.name AS "TermName"
                    FROM academic.timetable AS entity
    ...
    public sealed class Handler(IGetTimetableByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/timetable/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetTimetableByAcademicYearId")
