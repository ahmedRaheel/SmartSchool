...
public static class GetTimetableByTermId
{
    ...
    public interface IGetTimetableByTermIdQuery
    {
    ...
    internal sealed class GetTimetableByTermIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTimetableByTermIdQuery
    {
    ...
    public sealed class Handler(IGetTimetableByTermIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/organization/timetable/by-term/{parentId:guid}",
