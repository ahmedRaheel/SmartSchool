...
public static class UpdateTimetable
{
    ...
    public interface IUpdateTimetableCommand
    {
        Task UpdateAsync(
...
Task<TimetableEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateTimetableCommand(IOrganizationDbContext dbContext) : IUpdateTimetableCommand
    {
    ...
    public sealed class Handler(IUpdateTimetableCommand command)
