...
public static class CreateTimetable
{
    ...
    public sealed class Handler(ICreateTimetableCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("Timetable", "TIM", request.TenantId, 3, cancellationToken);
    ...
    {
        endpoints.MapPost(
                ApiRoutes.EntityCollection("academics", "timetable"),
