...
Task<SubjectEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateSubjectCommand(IOrganizationDbContext dbContext) : IUpdateSubjectCommand
    {
    ...
    public sealed class Handler(IUpdateSubjectCommand command)
