...
public static class GetAcademicSystemById
{
    ...
    public interface IGetAcademicSystemByIdQuery
    {
    ...
    internal sealed class GetAcademicSystemByIdQuery(
        IDbConnectionFactory connectionFactory) : IGetAcademicSystemByIdQuery
    {
    ...
    public sealed class Handler(IGetAcademicSystemByIdQuery query)
