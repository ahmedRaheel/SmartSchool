...
public static class GetAcademicSystemPage
{
    ...
    public interface IGetAcademicSystemPageQuery
    {
    ...
    internal sealed class GetAcademicSystemPageQuery(
        IDbConnectionFactory connectionFactory) : IGetAcademicSystemPageQuery
    {
    ...
    public sealed class Handler(IGetAcademicSystemPageQuery query)
