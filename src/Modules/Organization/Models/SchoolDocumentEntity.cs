...
/// <summary>
/// Stores metadata for a document attached to a school.
...
public sealed class SchoolDocumentEntity : Entity
{
	...
	/// <summary>Gets the owning school identifier.</summary>
	...
	/// <summary>Creates document metadata for a school.</summary>
	public static SchoolDocumentEntity Create(
		Guid tenantId,
		Guid schoolId,
		DocumentMetadata metadata)
	{
		...
		return new SchoolDocumentEntity
		{
			TenantId = tenantId,
			SchoolId = schoolId,
