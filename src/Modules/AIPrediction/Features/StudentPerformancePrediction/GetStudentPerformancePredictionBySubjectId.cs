...
public static class GetStudentPerformancePredictionBySubjectId
{
    ...
    public interface IGetStudentPerformancePredictionBySubjectIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetStudentPerformancePredictionBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-subject/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionBySubjectId")
