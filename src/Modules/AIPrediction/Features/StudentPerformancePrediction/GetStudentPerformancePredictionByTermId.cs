...
public static class GetStudentPerformancePredictionByTermId
{
    ...
    public interface IGetStudentPerformancePredictionByTermIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByTermIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByTermIdQuery
    {
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByTermIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-term/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByTermId")
