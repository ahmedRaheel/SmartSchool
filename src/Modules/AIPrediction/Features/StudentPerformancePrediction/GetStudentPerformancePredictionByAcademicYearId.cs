...
public static class GetStudentPerformancePredictionByAcademicYearId
{
    ...
    public interface IGetStudentPerformancePredictionByAcademicYearIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByAcademicYearId")
