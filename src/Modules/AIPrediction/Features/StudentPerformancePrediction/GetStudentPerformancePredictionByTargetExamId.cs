...
public static class GetStudentPerformancePredictionByTargetExamId
{
    ...
    public interface IGetStudentPerformancePredictionByTargetExamIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByTargetExamIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByTargetExamIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                ...
                WHERE entity.tenant_id = @TenantId
                  AND entity.target_exam_id = @ParentId
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByTargetExamIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-target-exam/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByTargetExamId")
