...
public static class GetStudentPerformancePredictionByPredictionModelId
{
    ...
    public interface IGetStudentPerformancePredictionByPredictionModelIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByPredictionModelIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByPredictionModelIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                ...
                WHERE entity.tenant_id = @TenantId
                  AND entity.prediction_model_id = @ParentId
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByPredictionModelIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-prediction-model/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByPredictionModelId")
