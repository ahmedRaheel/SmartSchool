...
public static class GetStudentPerformancePredictionByStudentId
{
    ...
    public interface IGetStudentPerformancePredictionByStudentIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-student/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByStudentId")
