...
public static class GetStudentPerformancePredictionByTargetExamSubjectId
{
    ...
    public interface IGetStudentPerformancePredictionByTargetExamSubjectIdQuery
    {
    ...
    internal sealed class GetStudentPerformancePredictionByTargetExamSubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentPerformancePredictionByTargetExamSubjectIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                ...
                WHERE entity.tenant_id = @TenantId
                  AND entity.target_exam_subject_id = @ParentId
    ...
    public sealed class Handler(IGetStudentPerformancePredictionByTargetExamSubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-performance-prediction/by-target-exam-subject/{parentId:guid}",
            ...
            .WithName("GetStudentPerformancePredictionByTargetExamSubjectId")
