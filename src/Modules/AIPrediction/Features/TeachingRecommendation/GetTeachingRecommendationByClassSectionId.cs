...
public static class GetTeachingRecommendationByClassSectionId
{
    ...
    public interface IGetTeachingRecommendationByClassSectionIdQuery
    {
    ...
    internal sealed class GetTeachingRecommendationByClassSectionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTeachingRecommendationByClassSectionIdQuery
    {
    ...
    public sealed class Handler(IGetTeachingRecommendationByClassSectionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/teaching-recommendation/by-class-section/{parentId:guid}",
            ...
            .WithName("GetTeachingRecommendationByClassSectionId")
