...
public static class GetTeachingRecommendationBySubjectId
{
    ...
    public interface IGetTeachingRecommendationBySubjectIdQuery
    {
    ...
    internal sealed class GetTeachingRecommendationBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTeachingRecommendationBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetTeachingRecommendationBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/teaching-recommendation/by-subject/{parentId:guid}",
            ...
            .WithName("GetTeachingRecommendationBySubjectId")
