...
public static class GetTeachingRecommendationByCourseOfferingId
{
    ...
    public interface IGetTeachingRecommendationByCourseOfferingIdQuery
    {
    ...
    internal sealed class GetTeachingRecommendationByCourseOfferingIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTeachingRecommendationByCourseOfferingIdQuery
    {
    ...
    public sealed class Handler(IGetTeachingRecommendationByCourseOfferingIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/teaching-recommendation/by-course-offering/{parentId:guid}",
            ...
            .WithName("GetTeachingRecommendationByCourseOfferingId")
