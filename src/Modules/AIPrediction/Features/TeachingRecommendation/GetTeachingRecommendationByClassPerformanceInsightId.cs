...
public static class GetTeachingRecommendationByClassPerformanceInsightId
{
    ...
    public interface IGetTeachingRecommendationByClassPerformanceInsightIdQuery
    {
    ...
    internal sealed class GetTeachingRecommendationByClassPerformanceInsightIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTeachingRecommendationByClassPerformanceInsightIdQuery
    {
    ...
    public sealed class Handler(IGetTeachingRecommendationByClassPerformanceInsightIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/teaching-recommendation/by-class-performance-insight/{parentId:guid}",
            ...
            .WithName("GetTeachingRecommendationByClassPerformanceInsightId")
