...
public static class GetTeachingRecommendationPage
{
	...
	public interface IGetTeachingRecommendationPage
	{
	...
	internal sealed class GetTeachingRecommendationPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetTeachingRecommendationPage
	{
	...
	public sealed class Handler(IGetTeachingRecommendationPage dataAccess)
