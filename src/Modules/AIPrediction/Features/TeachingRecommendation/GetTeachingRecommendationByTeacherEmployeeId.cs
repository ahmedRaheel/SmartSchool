...
public static class GetTeachingRecommendationByTeacherEmployeeId
{
    ...
    public interface IGetTeachingRecommendationByTeacherEmployeeIdQuery
    {
    ...
    internal sealed class GetTeachingRecommendationByTeacherEmployeeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTeachingRecommendationByTeacherEmployeeIdQuery
    {
    ...
    public sealed class Handler(IGetTeachingRecommendationByTeacherEmployeeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/teaching-recommendation/by-teacher-employee/{parentId:guid}",
            ...
            .WithName("GetTeachingRecommendationByTeacherEmployeeId")
