...
public static class CreatePredictionModel
{
    ...
    public interface ICreatePredictionModelCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreatePredictionModelCommand(IAIPredictionDbContext dbContext) : ICreatePredictionModelCommand
    {
    ...
    public sealed class Handler(ICreatePredictionModelCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("PredictionModel", "PMD", request.TenantId, 3, cancellationToken);
