...
public static class GetClassPerformanceInsightByTermId
{
    ...
    public interface IGetClassPerformanceInsightByTermIdQuery
    {
    ...
    internal sealed class GetClassPerformanceInsightByTermIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassPerformanceInsightByTermIdQuery
    {
    ...
    public sealed class Handler(IGetClassPerformanceInsightByTermIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/class-performance-insight/by-term/{parentId:guid}",
            ...
            .WithName("GetClassPerformanceInsightByTermId")
