...
public static class GetClassPerformanceInsightByCourseOfferingId
{
    ...
    public interface IGetClassPerformanceInsightByCourseOfferingIdQuery
    {
    ...
    internal sealed class GetClassPerformanceInsightByCourseOfferingIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassPerformanceInsightByCourseOfferingIdQuery
    {
    ...
    public sealed class Handler(IGetClassPerformanceInsightByCourseOfferingIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/class-performance-insight/by-course-offering/{parentId:guid}",
            ...
            .WithName("GetClassPerformanceInsightByCourseOfferingId")
