...
public static class GetClassPerformanceInsightByAcademicYearId
{
    ...
    public interface IGetClassPerformanceInsightByAcademicYearIdQuery
    {
    ...
    internal sealed class GetClassPerformanceInsightByAcademicYearIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassPerformanceInsightByAcademicYearIdQuery
    {
    ...
    public sealed class Handler(IGetClassPerformanceInsightByAcademicYearIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/class-performance-insight/by-academic-year/{parentId:guid}",
            ...
            .WithName("GetClassPerformanceInsightByAcademicYearId")
