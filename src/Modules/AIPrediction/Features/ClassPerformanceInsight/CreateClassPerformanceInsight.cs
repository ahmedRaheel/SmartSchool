...
public static class CreateClassPerformanceInsight
{
    ...
    public sealed class Handler(ICreateClassPerformanceInsightCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("ClassPerformanceInsight", "CPI", request.TenantId, 3, cancellationToken);
