...
public static class GetClassPerformanceInsightByClassSectionId
{
    ...
    public interface IGetClassPerformanceInsightByClassSectionIdQuery
    {
    ...
    internal sealed class GetClassPerformanceInsightByClassSectionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetClassPerformanceInsightByClassSectionIdQuery
    {
    ...
    public sealed class Handler(IGetClassPerformanceInsightByClassSectionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/class-performance-insight/by-class-section/{parentId:guid}",
            ...
            .WithName("GetClassPerformanceInsightByClassSectionId")
