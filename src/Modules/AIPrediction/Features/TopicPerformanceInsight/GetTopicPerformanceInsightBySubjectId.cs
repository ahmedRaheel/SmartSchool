...
public static class GetTopicPerformanceInsightBySubjectId
{
    ...
    public interface IGetTopicPerformanceInsightBySubjectIdQuery
    {
    ...
    internal sealed class GetTopicPerformanceInsightBySubjectIdQuery(IDbConnectionFactory connectionFactory)
        : IGetTopicPerformanceInsightBySubjectIdQuery
    {
    ...
    public sealed class Handler(IGetTopicPerformanceInsightBySubjectIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/topic-performance-insight/by-subject/{parentId:guid}",
            ...
            .WithName("GetTopicPerformanceInsightBySubjectId")
