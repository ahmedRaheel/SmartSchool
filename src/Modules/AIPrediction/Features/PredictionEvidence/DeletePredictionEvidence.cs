...
public static class DeletePredictionEvidence
{
    ...
    public interface IDeletePredictionEvidenceCommand
    {
        Task DeleteAsync(
    ...
    internal sealed class DeletePredictionEvidenceCommand(IAIPredictionDbContext dbContext) : IDeletePredictionEvidenceCommand
    {
    ...
    public sealed class Handler(IDeletePredictionEvidenceCommand command)
