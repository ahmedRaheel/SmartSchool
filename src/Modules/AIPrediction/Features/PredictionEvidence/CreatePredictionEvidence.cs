...
public static class CreatePredictionEvidence
{
    ...
    public interface ICreatePredictionEvidenceCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreatePredictionEvidenceCommand(IAIPredictionDbContext dbContext) : ICreatePredictionEvidenceCommand
    {
    ...
    public sealed class Handler(ICreatePredictionEvidenceCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("PredictionEvidence", "PEV", request.TenantId, 3, cancellationToken);
