...
public static class UpdatePredictionEvidence
{
	/// <summary>
	...
	public interface IUpdatePredictionEvidence
	{
		Task UpdateAsync(
	...
	internal sealed class UpdatePredictionEvidenceDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : IUpdatePredictionEvidence
	{
	...
	public sealed class Handler(IUpdatePredictionEvidence dataAccess)
		: IRequestHandler<Request, Result<Response>>
	{
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(PredictionEvidenceEntity), request.Code)));
			}
	...
	public static IEndpointRouteBuilder MapEndpoint(IEndpointRouteBuilder endpoints)
	{
		endpoints.MapPut(
			...
			.WithName("UpdatePredictionEvidence")
