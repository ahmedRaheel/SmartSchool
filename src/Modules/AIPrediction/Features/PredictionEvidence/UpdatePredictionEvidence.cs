...
public static class UpdatePredictionEvidence
{
    ...
    public interface IUpdatePredictionEvidenceCommand
    {
        Task UpdateAsync(
...
Task<PredictionEvidenceEntity?> GetByIdAsync(
    ...
    internal sealed class UpdatePredictionEvidenceCommand(IAIPredictionDbContext dbContext) : IUpdatePredictionEvidenceCommand
    {
    ...
    public sealed class Handler(IUpdatePredictionEvidenceCommand command)
