...
public static class GetStudentInterventionByStudentId
{
    ...
    public interface IGetStudentInterventionByStudentIdQuery
    {
    ...
    internal sealed class GetStudentInterventionByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentInterventionByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetStudentInterventionByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-intervention/by-student/{parentId:guid}",
            ...
            .WithName("GetStudentInterventionByStudentId")
