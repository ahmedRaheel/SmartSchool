...
public static class GetStudentInterventionBySourcePredictionId
{
    ...
    public interface IGetStudentInterventionBySourcePredictionIdQuery
    {
    ...
    internal sealed class GetStudentInterventionBySourcePredictionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentInterventionBySourcePredictionIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.source_prediction_id = @ParentId
    ...
    public sealed class Handler(IGetStudentInterventionBySourcePredictionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-intervention/by-source-prediction/{parentId:guid}",
            ...
            .WithName("GetStudentInterventionBySourcePredictionId")
