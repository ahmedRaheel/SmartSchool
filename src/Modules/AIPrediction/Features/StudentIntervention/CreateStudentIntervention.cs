...
public static class CreateStudentIntervention
{
    ...
    public sealed class Handler(ICreateStudentInterventionCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("StudentIntervention", "SI", request.TenantId, 3, cancellationToken);
