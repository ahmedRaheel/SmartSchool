...
public static class GetStudentInterventionByTeacherEmployeeId
{
    ...
    public interface IGetStudentInterventionByTeacherEmployeeIdQuery
    {
    ...
    internal sealed class GetStudentInterventionByTeacherEmployeeIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentInterventionByTeacherEmployeeIdQuery
    {
    ...
    public sealed class Handler(IGetStudentInterventionByTeacherEmployeeIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-intervention/by-teacher-employee/{parentId:guid}",
            ...
            .WithName("GetStudentInterventionByTeacherEmployeeId")
