...
public static class GetStudentInterventionBySourceRecommendationId
{
    ...
    public interface IGetStudentInterventionBySourceRecommendationIdQuery
    {
    ...
    internal sealed class GetStudentInterventionBySourceRecommendationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentInterventionBySourceRecommendationIdQuery
    {
            ...
            CancellationToken cancellationToken)
        {
            const string sql = """
                    ...
                    WHERE entity.tenant_id = @TenantId
                      AND entity.source_recommendation_id = @ParentId
    ...
    public sealed class Handler(IGetStudentInterventionBySourceRecommendationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-intervention/by-source-recommendation/{parentId:guid}",
            ...
            .WithName("GetStudentInterventionBySourceRecommendationId")
