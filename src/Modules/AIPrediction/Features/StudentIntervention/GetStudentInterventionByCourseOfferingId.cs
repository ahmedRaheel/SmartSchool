...
public static class GetStudentInterventionByCourseOfferingId
{
    ...
    public interface IGetStudentInterventionByCourseOfferingIdQuery
    {
    ...
    internal sealed class GetStudentInterventionByCourseOfferingIdQuery(IDbConnectionFactory connectionFactory)
        : IGetStudentInterventionByCourseOfferingIdQuery
    {
    ...
    public sealed class Handler(IGetStudentInterventionByCourseOfferingIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/student-intervention/by-course-offering/{parentId:guid}",
            ...
            .WithName("GetStudentInterventionByCourseOfferingId")
