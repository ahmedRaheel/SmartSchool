...
public static class UpdatePredictionEvaluation
{
    ...
    public interface IUpdatePredictionEvaluationCommand
    {
        Task UpdateAsync(
...
Task<PredictionEvaluationEntity?> GetByIdAsync(
    ...
    internal sealed class UpdatePredictionEvaluationCommand(IAIPredictionDbContext dbContext) : IUpdatePredictionEvaluationCommand
    {
    ...
    public sealed class Handler(IUpdatePredictionEvaluationCommand command)
