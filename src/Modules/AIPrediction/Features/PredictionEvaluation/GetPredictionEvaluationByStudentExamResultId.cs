...
public static class GetPredictionEvaluationByStudentExamResultId
{
    ...
    public interface IGetPredictionEvaluationByStudentExamResultIdQuery
    {
    ...
    internal sealed class GetPredictionEvaluationByStudentExamResultIdQuery(IDbConnectionFactory connectionFactory)
        : IGetPredictionEvaluationByStudentExamResultIdQuery
    {
    ...
    public sealed class Handler(IGetPredictionEvaluationByStudentExamResultIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/aiprediction/prediction-evaluation/by-student-exam-result/{parentId:guid}",
            ...
            .WithName("GetPredictionEvaluationByStudentExamResultId")
