...
/// <summary>
/// Represents the PredictionModelEntity domain entity.
/// </summary>
public sealed class PredictionModelEntity : Entity
{
	/// <summary>Gets the persisted entity identifier.</summary>
	public Guid PredictionModelId
	{
		get => Id;
	...
	/// <summary>Creates a new PredictionModelEntity.</summary>
	/// <param name="tenantId">The owning tenant identifier.</param>
	/// <param name="code">The business code.</param>
	/// <param name="name">The display name.</param>
	/// <param name="metadataJson">Optional domain metadata.</param>
	/// <returns>The newly created entity.</returns>
	public static PredictionModelEntity Create(
		Guid tenantId,
		string code,
		string name,
		string? metadataJson = null)
	{
		...
		return new PredictionModelEntity
		{
			TenantId = tenantId,
			Code = code.Trim(),
			Name = name.Trim(),
