...
/// <summary>
/// Defines relational persistence rules for <see cref="PredictionModelEntity"/>.
/// </summary>
public sealed class PredictionModelEntityConfiguration
	: IEntityTypeConfiguration<PredictionModelEntity>
{
	public void Configure(EntityTypeBuilder<PredictionModelEntity> builder)
	{
		builder.ToTable("prediction_model", schema: "ai");
		builder.HasKey(entity => entity.PredictionModelId);
