...
public static class GetIncrementPage
{
    ...
    public interface IGetIncrementPageQuery
    {
    ...
    internal sealed class GetIncrementPageQuery(
        IDbConnectionFactory connectionFactory) : IGetIncrementPageQuery
    {
    ...
    public sealed class Handler(IGetIncrementPageQuery query)
