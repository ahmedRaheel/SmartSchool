...
public static class UpdatePayslip
{
    ...
    public interface IUpdatePayslipCommand
    {
        Task UpdateAsync(
...
Task<PayslipEntity?> GetByIdAsync(
    ...
    internal sealed class UpdatePayslipCommand(IPayrollDbContext dbContext) : IUpdatePayslipCommand
    {
    ...
    public sealed class Handler(IUpdatePayslipCommand command)
