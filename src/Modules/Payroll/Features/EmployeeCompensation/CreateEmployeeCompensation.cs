...
public static class CreateEmployeeCompensation
{
    ...
    public sealed class Handler(ICreateEmployeeCompensationCommand command, IBusinessNumberGenerator numberGenerator)
        : IRequestHandler<Request, Result<Response>>
    {
        public async Task<Result<Response>> HandleAsync(
            ...
            CancellationToken cancellationToken)
        {
            var code = await numberGenerator.NextAsync("EmployeeCompensation", "EC", request.TenantId, 3, cancellationToken);
