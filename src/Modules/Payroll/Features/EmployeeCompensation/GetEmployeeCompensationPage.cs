...
public static class GetEmployeeCompensationPage
{
	...
	public interface IGetEmployeeCompensationPage
	{
	...
	internal sealed class GetEmployeeCompensationPagePersistence(
		IDbConnectionFactory connectionFactory) : IGetEmployeeCompensationPage
	{
	...
	public sealed class Handler(IGetEmployeeCompensationPage dataAccess)
