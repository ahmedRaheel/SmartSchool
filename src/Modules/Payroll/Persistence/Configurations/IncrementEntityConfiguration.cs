...
/// <summary>
/// Defines relational persistence rules for <see cref="IncrementEntity"/>.
/// </summary>
public sealed class IncrementEntityConfiguration
	: IEntityTypeConfiguration<IncrementEntity>
{
	public void Configure(EntityTypeBuilder<IncrementEntity> builder)
	{
		...
		builder.Property(entity => entity.IncrementId).HasColumnName("increment_id");
	}
}
