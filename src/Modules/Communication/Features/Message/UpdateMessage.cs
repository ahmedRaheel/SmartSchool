...
Task<MessageEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateMessageCommand(ICommunicationDbContext dbContext) : IUpdateMessageCommand
    {
    ...
    public sealed class Handler(IUpdateMessageCommand command)
