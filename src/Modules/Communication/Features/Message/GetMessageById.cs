...
public static class GetMessageById
{
	...
	internal sealed class GetMessageByIdPersistence(
		IDbConnectionFactory connectionFactory) : IGetMessageById
	{
	...
	public sealed class Handler(IGetMessageById dataAccess)
