...
public static class GetMessageByConversationId
{
    ...
    public interface IGetMessageByConversationIdQuery
    {
    ...
    internal sealed class GetMessageByConversationIdQuery(IDbConnectionFactory connectionFactory)
        : IGetMessageByConversationIdQuery
    {
    ...
    public sealed class Handler(IGetMessageByConversationIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/communication/message/by-conversation/{parentId:guid}",
            ...
            .WithName("GetMessageByConversationId")
