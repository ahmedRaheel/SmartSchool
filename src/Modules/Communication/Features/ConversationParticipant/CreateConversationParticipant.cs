...
public static class CreateConversationParticipant
{
	...
	public interface ICreateConversationParticipant
	{
		Task AddAsync(
	...
	internal sealed class CreateConversationParticipantDataAccess(
		IApplicationDbContext dbContext,
		IDbConnectionFactory connectionFactory) : ICreateConversationParticipant
	{
	...
	public sealed class Handler(ICreateConversationParticipant dataAccess)
			...
			CancellationToken cancellationToken)
		{
			...
			if (exists)
			{
				return Result<Response>.Failure(
					Error.Conflict(
						ErrorMessages.DuplicateCode(nameof(ConversationParticipantEntity), request.Code)));
			}
	...
	private static Response MapResponse(ConversationParticipantEntity entity)
	{
		return new Response(
			entity.TenantId,
