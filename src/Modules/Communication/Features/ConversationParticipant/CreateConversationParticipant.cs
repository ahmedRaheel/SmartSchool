...
public static class CreateConversationParticipant
{
    ...
    public interface ICreateConversationParticipantCommand
    {
        Task AddAsync(
    ...
    internal sealed class CreateConversationParticipantCommand(ICommunicationDbContext dbContext) : ICreateConversationParticipantCommand
    {
