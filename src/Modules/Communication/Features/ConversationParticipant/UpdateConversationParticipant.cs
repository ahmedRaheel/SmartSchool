...
public static class UpdateConversationParticipant
{
    ...
    public interface IUpdateConversationParticipantCommand
    {
        Task UpdateAsync(
...
Task<ConversationParticipantEntity?> GetByIdAsync(
    ...
    internal sealed class UpdateConversationParticipantCommand(ICommunicationDbContext dbContext) : IUpdateConversationParticipantCommand
    {
    ...
    public sealed class Handler(IUpdateConversationParticipantCommand command)
