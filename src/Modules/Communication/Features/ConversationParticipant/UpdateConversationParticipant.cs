...
public static class UpdateConversationParticipant
{
	...
	public interface IUpdateConversationParticipant
	{
		Task UpdateAsync(
...
Task<ConversationParticipantEntity?> GetByIdAsync(
	...
	internal sealed class UpdateConversationParticipantPersistence(ICommunicationDbContext dbContext) : IUpdateConversationParticipant
	{
	...
	public sealed class Handler(IUpdateConversationParticipant dataAccess)
