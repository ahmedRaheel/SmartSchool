...
public static class GetConversationParticipantPage
{
	...
	public interface IGetConversationParticipantPage
	{
	...
	internal sealed class GetConversationParticipantPageDataAccess(
		IDbConnectionFactory connectionFactory) : IGetConversationParticipantPage
	{
	...
	public sealed class Handler(IGetConversationParticipantPage dataAccess)
