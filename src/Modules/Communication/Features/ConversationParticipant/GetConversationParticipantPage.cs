...
public static class GetConversationParticipantPage
{
    ...
    public interface IGetConversationParticipantPageQuery
    {
    ...
    internal sealed class GetConversationParticipantPageQuery(
        IDbConnectionFactory connectionFactory) : IGetConversationParticipantPageQuery
    {
    ...
    public sealed class Handler(IGetConversationParticipantPageQuery query)
