...
public static class GetConversationByStudentId
{
    ...
    public interface IGetConversationByStudentIdQuery
    {
    ...
    internal sealed class GetConversationByStudentIdQuery(IDbConnectionFactory connectionFactory)
        : IGetConversationByStudentIdQuery
    {
    ...
    public sealed class Handler(IGetConversationByStudentIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/communication/conversation/by-student/{parentId:guid}",
            ...
            .WithName("GetConversationByStudentId")
