...
public static class GetConversationByCampusId
{
    ...
    public interface IGetConversationByCampusIdQuery
    {
    ...
    internal sealed class GetConversationByCampusIdQuery(IDbConnectionFactory connectionFactory)
        : IGetConversationByCampusIdQuery
    {
    ...
    public sealed class Handler(IGetConversationByCampusIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/communication/conversation/by-campus/{parentId:guid}",
            ...
            .WithName("GetConversationByCampusId")
