...
public static class GetConversationByClassSectionId
{
    ...
    public interface IGetConversationByClassSectionIdQuery
    {
    ...
    internal sealed class GetConversationByClassSectionIdQuery(IDbConnectionFactory connectionFactory)
        : IGetConversationByClassSectionIdQuery
    {
    ...
    public sealed class Handler(IGetConversationByClassSectionIdQuery query)
    ...
    {
        endpoints.MapGet(
                "/api/communication/conversation/by-class-section/{parentId:guid}",
            ...
            .WithName("GetConversationByClassSectionId")
